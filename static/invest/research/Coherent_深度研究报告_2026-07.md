...
| 估值容错率 | 当前价格锚点：$333.36 | 高预期标的必须有更干净的兑现 | Caution |
...
| 估值韧性 | Base price context $333.36; bull context $416.70 | 基本面继续验证，倍数不收缩 |
...
| --- | --- | --- |
| 预期风险 | 当前价格锚点 $333.36 | 公司表现不错但已经无法超过内嵌预期 |
| 链条分化 | 相邻报告无法确认同一信号 | 瓶颈在其他 layer，或需求被提前拉动 |
| 执行风险 | guidance、backlog 或产能转化放缓 | 报告证据停止支持该角色 |
| 估值压缩 | Bear context $233.35; base context $333.36 | 长期故事未变但倍数先收缩 |
