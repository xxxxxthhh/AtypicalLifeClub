...
| Scenario | Driver assumptions (tungsten price / Sangdong / cost / financing) | Valuation implication *(stale — written against the old price)* | Probability weight *(stale as written — re-adjudicated 2026-07-31: weights retained)* |
|----------|-------------------------------------------------------------------|------------------------------------------------------|--------------------|
