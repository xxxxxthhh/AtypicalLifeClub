...
> **2026-07-31 valuation re-anchor.** VRT closed at **$223.04** on **2026-07-29** (the then-last completed session; old low, superseded by the re-adjudication below), **-27.3%** from the old $306.97 anchor dated 2026-06-29. This is part of the verified July 2026 chain-wide AI-infrastructure repricing — checked for corporate actions and confirmed a real price move. Recomputed at the new price: market cap about **$85.7B**, enterprise value about **$85.8B**, P/S (TTM) about **7.5x**, EV/Sales (TTM) about **7.5x**. The dated price, market-cap and multiple figures below are **superseded as levels**; read them as of their labels.
>
> The scenario grid's relative verdicts and probability weights were written against the old price and are **not re-weighted here** — the drawdown changed what is being paid, not the execution questions the grid is about. Stance and conviction are unchanged and raised under Q1 of the review questions doc. Vertiv already integrated its Q2 2026 results on 2026-07-30; that operating evidence is unchanged and current. This pass adds the price re-anchor.

> **2026-07-31 stance re-adjudication at the 2026-07-30 close — supersedes the "not re-weighted / stance unchanged" language in the old note above.** Owner ruling on Q1 of the review-questions doc (2026-07-31): a published stance and its rationale must hold at the current price — the assessment is re-derived at the latest completed close rather than held open for future evidence. VRT closed at **$227.50** on **2026-07-30**, only +2.0% off the old 2026-07-29 low of $223.04 — Vertiv barely participated in the 07-30 bounce — and still **-25.9%** from the old $306.97 anchor. Recomputed on the report's own frames: market cap about **$87.4B**, enterprise value about **$87.5B**, P/S (TTM) about **7.7x**. On the raised FY2026 guide of $6.65-6.75 adjusted EPS, the forward multiple is about **34x**, and the report's own reverse-multiple frame — normalize toward ~32x over three years at an 8% required return — now implies roughly **10% EPS CAGR**, against the ~24% bar computed at the old anchor. A base case of high-teens/low-20s EPS CAGR clears that implied bar with room to spare, so the negative expectation gap that made the stance cautious is gone at the current price. The unquantified Q2 orders/backlog disclosure and the high-beta order book are watch items, not an avoidance case. **Stance moves cautious -> neutral-watch (medium conviction).** Grid weights (20/50/30) re-checked and retained; the grid's valuation-implication column should be read against this anchor. This discharges the scenario-grid-reweight-pending monitoring item ahead of the 2026-10-21 print.

> **2026-08-18 stance re-anchor at the 2026-08-17 close — supersedes the 2026-07-31 adjudication above as the current view.** Under the owner's Q1 ruling (a published stance is re-derived at the latest completed close, not held open for the next print), VRT closed at **$292.43** on **2026-08-17** — **+28.5%** in two weeks from the $227.50 adjudication anchor, and back within ~4.7% of the old $306.97 June anchor. The FY2026 guide is unchanged ($6.65-6.75 adjusted EPS; no new reported quarter since the 07-29 release), so the entire move is multiple re-expansion, not denominator growth. Recomputed on the report's own frames: market cap about **$112.6B** (384.937M shares), enterprise value about **$112.7B** (Q2 2026 net debt ~$0.1B: cash $2,810.6M vs total debt $2,939.8M per the Q2 10-Q), P/S (TTM through Q2 2026, ~$11.48B revenue) about **9.8x**, trailing GAAP P/E about **65x** (TTM net income ~$1.73B, TTM EPS ~$4.51). On the raised guide the forward multiple is about **43.6x** (43.3-44.0x across the range), and the report's reverse-multiple frame — normalize toward ~32x over three years at an 8% required return — implies roughly **20% EPS CAGR**, versus ~10% at the 07-31 anchor and ~24% at the June anchor. That bar sits at the very top of the base case's high-teens-to-low-20s band: a base-midpoint delivery (~20% CAGR into a ~32x multiple) returns roughly the 8% required rate and nothing more, an 18% delivery falls short (~6%/yr), and ~43.6x is above even the bull scenario's own 35-40x holding assumption. With the 20/50/30 weights re-checked and retained, the probability-weighted expectation gap re-opens negative — the same shape as the June cautious call at a less extreme level — while the orders/backlog falsifier remains untested since Q4 2025. Neither published trigger fired: the upgrade path is conjunctive and its "no further forward-multiple expansion" leg is now violated by the +28.5% move, and the downgrade disjuncts are business-evidence conditions, none of which has been observed — this flip is a price-driven re-derivation under the Q1 policy. The published triggers are therefore changed as little as the new stance allows: both landing points are re-pointed one step (upgrade back to neutral-watch, downgrade on to bearish-avoid), and the upgrade path's now-unsatisfiable "no further forward-multiple expansion" leg is restated as "with the forward multiple having retreated." Its four operating conditions — orders/book-to-bill above 1.5x, growing backlog, improving liquid-cooling/power share, margin above the 23% guide path — are retained verbatim, so a price decline alone still cannot trigger an upgrade without a verifiable orders disclosure. **Stance moves neutral-watch -> cautious (medium conviction).**

**Verdict:** ~~Cautious / medium conviction: high-quality franchise, but the price implies a near-perfect buildout pace.~~ ~~Neutral-watch / medium conviction (re-adjudicated 2026-07-31 at the $227.50 close — the implied EPS bar is now roughly 10% CAGR, not the old ~24%; see the header note).~~ **Cautious / medium conviction (re-adjudicated 2026-08-18 at the $292.43 close — the implied EPS bar is back to roughly 20% CAGR, at the top of the base band; see the 2026-08-18 header note).** Vertiv is arguably the cleanest single barometer of AI-capex *velocity*, and execution (margin, FCF, backlog) is excellent. But the stock has roughly **tripled in a year** to **$306.97** (~**$117.9B** market cap, ~**48x** FY2026E adjusted EPS, ~**80x** trailing GAAP), so it already prices in years of sustained buildout. The debate is not whether AI data-center demand is real (the latest disclosed backlog supports it) but whether the *pace* holds — because Vertiv's high-beta order book cuts both ways.

**Current market read (latest market-data snapshot, 2026-06-29 close):** *Old frame, superseded by the 2026-07-31 re-anchor — the price, market cap, enterprise value and every multiple in this paragraph are old-caliber levels:* VRT closed **$306.97** on 2026-06-29, below quote-source/IBD references to a 52-week/all-time high near **$379.94** in May 2026. On ~**384M** shares, market cap is ~**$117.9B** (~$146B at the ~$379.94 high); with ~$3.26B debt securities and finance-lease obligations and ~$2.50B cash (net debt ~**$0.76B**, excluding operating lease liabilities), enterprise value is ~**$118.7B**. The stock is up roughly **100% YTD** and about 3x over the past year. Financial source: [Vertiv Q1 2026 8-K (SEC)](https://www.sec.gov/Archives/edgar/data/0001674101/000162828026026379/q12026exhibit991vrt04222026.htm); quote references: [Yahoo Finance VRT](https://finance.yahoo.com/quote/VRT/), [StockAnalysis VRT](https://stockanalysis.com/stocks/vrt/), [Investor's Business Daily VRT profile](https://www.investors.com/stock-lists/sector-leaders/vertiv-vrt-stock-ai/).

**Key data:**

| Metric | Value |
|--------|-------|
| Price | ~~(old caliber) $306.97 (2026-06-29 close)~~ **$292.43 (2026-08-17 close; +28.5% from the old $227.50 anchor dated 2026-07-31)** |
| Market cap | ~~~$117.9B~~ **~$112.6B (384.937M shares)** |
| Net debt / EV | ~~~$0.76B net debt; EV ~$118.7B~~ **~$0.1B net debt at Q2 2026 ($2,939.8M debt − $2,810.6M cash); EV ~$112.7B** |
| Forward P/E | ~~~48x (FY2026E adj EPS $6.30-6.40)~~ **~43.6x on the raised FY2026E adj EPS $6.65-6.75 (guidance denominator)** |
| Trailing P/E (GAAP) | ~~~80x~~ **~65x (TTM through Q2 2026: net income ~$1.73B, EPS ~$4.51 — reported-results denominator, not comparable to the forward guide basis)** |
| P/S (TTM) | **~9.8x (TTM revenue ~$11.48B through Q2 2026)** |
| Implied EPS CAGR (reverse-multiple frame) | **~20% (43.6x → ~32x over 3y at an 8% required return); old anchors for comparison: ~10% at $227.50, ~24% at $306.97** |
| EV/EBITDA (FY2026E, est.) | ~~About 34x; EV/Sales ~8.6x (old caliber)~~ **~32-33x; EV/Sales ~8.1x on the FY2026E guide, ~9.8x on TTM revenue** |
...
**Core thesis:** ~~At ~$117.9B and ~48x forward adjusted EPS after a ~3x year (old caliber),~~ **2026-08-18 update: at ~$112.6B and ~43.6x forward adjusted EPS after a +28.5% two-week re-rating,** Vertiv prices in years of uninterrupted hyperscale buildout — and its high-beta order book means any deceleration hits hard and early.

1. **Valuation leaves no slack.** ~~About 48x FY2026E adj EPS, ~54x GAAP, ~80x trailing, ~8.6x EV/Sales (old caliber).~~ **2026-08-18 update: ~43.6x FY2026E adj EPS on the raised $6.65-6.75 guide, ~65x trailing GAAP, ~9.8x EV/Sales on TTM revenue** — priced for sustained ~30% growth; any wobble in AI-capex pace de-rates it fast.
...
- **Forward P/E:** ~~About 48x (FY2026E adjusted) / ~54x (GAAP) on the old $6.30-6.40 guide at the old-caliber $306.97.~~ **2026-08-18 update: ~43.6x on the raised FY2026E adjusted-EPS guide of $6.65-6.75 at the $292.43 close (43.3-44.0x across the guide range).** Richer than the compute names (NVIDIA ~25x, Broadcom ~33x forward) but below Corning's ~71x — reasonable *if* ~30% growth persists, demanding if it doesn't.
- **Trailing P/E:** ~~About 80x (old caliber).~~ **2026-08-18 update: ~65x GAAP on TTM net income of ~$1.73B (TTM EPS ~$4.51) through Q2 2026.** Note the denominator difference: the ~43.6x forward figure uses management's adjusted-EPS guidance, while this ~65x uses reported trailing GAAP results — the two are not directly comparable. It reflects how far earnings still are from the forward run-rate; the multiple only "works" on the forward ramp.
- **EV/EBITDA & EV/Sales:** ~~EV/EBITDA ~34x (FY2026E, est.) and EV/Sales ~8.6x on EV ~$118.7B (market cap ~$117.9B + net debt ~$0.76B), old caliber.~~ **2026-08-18 update: EV ~$112.7B (market cap ~$112.6B + Q2 2026 net debt ~$0.1B) on the ~$13.8-14.2B FY2026E guide and ~$3.4-3.5B est. adj EBITDA → EV/EBITDA ~32-33x and EV/Sales ~8.1x on the guide basis, or ~9.8x on TTM revenue of ~$11.48B.** Premium capital-goods multiples that embed continued double-digit growth and margin expansion.
...
| Scenario | Driver assumptions (backlog / liquid cooling and power equipment / margin / multiple) | Valuation implication *(stale — written against the old price)* | Probability weight *(stale as written — re-adjudicated 2026-07-31: weights retained)* |
|----------|---------------------------------------------------------|------------------------------------------------------|--------------------|
...
**What's priced in & the expectation gap:** *Old frame, superseded by the 2026-07-31 re-anchor — the price, market cap, enterprise value and every multiple in this paragraph are old-caliber levels:* At the $306.97 close on Jun 29, 2026 and about 48x FY2026E adjusted EPS, if forward P/E normalizes toward about 32x over three years with an 8% required return, the reverse-multiple frame implies about `(48 / 32)^(1/3) x 1.08 - 1`, or roughly **24% EPS CAGR**. Our base case needs backlog, liquid-cooling share, and 23%+ margins to keep delivering just to approach that hurdle; the 20% bull / 50% base / 30% bear blend says business quality is high, but the expectation gap is negative at the current price and the skew turns cautious. This is an expectations frame, not a target price. *(The 2026-07-30 monitoring pass adds Q2 2026 operating evidence — net sales $3.274B (+24%, +18% organic), adjusted operating margin 22.6%, adjusted FCF $925M, and a FY2026 guide raised to $6.65-6.75 adjusted EPS — but does **not** refresh the $306.97 share price, valuation multiple, stance, or conviction; the release did not quantify orders/backlog. The raised guide lowers the June-29 forward multiple from ~48x ($6.30-6.40 basis) to ~46x ($6.65-6.75 basis), so moving the valuation frame forward would require a separate current-price valuation review; any post-earnings share-price move alone is not a loggable signal.)*

**2026-08-18 update — current-price expectations frame (supersedes the paragraphs above as levels):** at the 2026-08-17 close of **$292.43** (market cap ~$112.6B, EV ~$112.7B, P/S TTM ~9.8x, trailing GAAP ~65x), the forward multiple on the raised $6.65-6.75 guide is about **43.6x**, and the same reverse-multiple frame implies about `(43.6 / 32)^(1/3) x 1.08 - 1`, or roughly **20% EPS CAGR** — back at the very top of the base case's high-teens-to-low-20s band. A base-midpoint delivery earns roughly the 8% required return with zero cushion, an 18% delivery undershoots it, and ~43.6x now exceeds even the bull scenario's own 35-40x holding range. The probability-weighted expectation gap re-opens negative on the 20/50/30 weights; stance re-adjudicated to **cautious / medium conviction** — see the 2026-08-18 header note. This is an expectations frame, not a target price.
...
**The quality is largely in the price.** ~~At (old caliber) $306.97 — roughly triple a year ago — Vertiv traded at ~48x FY2026E adjusted EPS (~80x trailing) and ~$117.9B.~~ **2026-08-18 update: at the $292.43 close Vertiv trades at ~43.6x FY2026E adjusted EPS (~65x trailing GAAP) and ~$112.6B**, pricing in years of sustained ~30% growth. The bet is on the *pace* of the buildout, and Vertiv's high-beta order book is the same instrument on the way down as on the way up: it would flash the warning first.
...
~~The current stance is **cautious, medium conviction**.~~ ~~2026-07-31 re-adjudication: the current stance is neutral-watch, medium conviction — at the $227.50 close the reverse-multiple frame implies only about 10% EPS CAGR and the negative gap stated below no longer holds.~~ **2026-08-18 re-adjudication: the current stance is cautious, medium conviction** — at the $292.43 close (+28.5% in two weeks on an unchanged guide) the reverse-multiple frame implies roughly 20% EPS CAGR, at the very top of the base case's high-teens-to-low-20s band and above the bull scenario's own 35-40x multiple assumption, so the negative expectation gap has re-opened; see the 2026-08-18 header note. The cautious reading does not deny Vertiv's business quality; it recognizes that the price again bundles multiple years of fast buildout, order durability, and margin expansion into one assumption. Medium conviction comes from strong Q1/Q2 growth, margin, FCF, and Q4 2025 backlog evidence, while Q3 orders, book-to-bill, and liquid-cooling competition will decide whether Vertiv can sustain the implied EPS hurdle. Use Vertiv as the chain's velocity gauge — and pair it with the CoreWeave / neocloud risk anchor, which tests whether that velocity is real economic demand or leverage-fueled.

Upgrade trigger: Move back to neutral-watch if Q3 orders/book-to-bill stays above 1.5x, backlog keeps growing, liquid-cooling/power-equipment share improves, and adjusted operating margin runs above the 23% guide path, with the forward multiple having retreated. Downgrade trigger: Move to bearish-avoid if orders/book-to-bill approaches or falls below 1x, backlog starts rolling over, liquid-cooling competition compresses gross or incremental margin, or hyperscaler capex guidance enters a digestion phase — any single piece of weakening business evidence against the ~43.6x forward multiple.
...
- Price (old caliber) $306.97 = 2026-06-29 U.S. close; 384.937M shares → market cap ~$117.9B (~$146B at a ~$379.94 high). Actual quoted price may differ intraday.
...
- 2026-08-18 stance re-anchor basis: price $292.43 = 2026-08-17 U.S. close (price ledger); 384.937M shares → market cap ~$112.6B; EV ~$112.7B on Q2 2026 net debt ~$0.1B (cash $2,810.6M vs total debt $2,939.8M, per the Q2 2026 10-Q). TTM revenue ~$11.48B and TTM GAAP net income ~$1.73B are the four quarters through 2026-06-30 (FY2025 10-K plus 10-Qs, SEC XBRL). Forward P/E ~43.6x uses the raised FY2026 adjusted-EPS guide of $6.65-6.75 (mid $6.70); note the denominator difference vs the ~65x trailing GAAP and ~9.8x P/S (TTM) figures, which use reported trailing GAAP results.
