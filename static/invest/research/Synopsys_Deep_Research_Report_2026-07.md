...
Move to bullish if Q3 FY2026 shows Ansys revenue and simulation synergies converting on plan, Design Automation and Design IP accelerating together, FCF tracking the roughly $2.0B guide, and no new export-control / Entity List shock. Move to neutral-watch or cautious if Ansys integration dilutes execution, Design IP or Design Automation growth falls short of the AI-complexity narrative, FCF misses the roughly $2.0B guide, or a new export-control / Entity List change breaks FY2026 guidance.
