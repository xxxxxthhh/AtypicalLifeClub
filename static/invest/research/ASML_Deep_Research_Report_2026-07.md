...
| --- | --- | --- |
| AMAT | broad equipment dashboard | Evidence moves in the same direction as this report |
| LRCX | etch/deposition dashboard | Evidence moves in the same direction as this report |
| KLAC | process-control dashboard | Evidence moves in the same direction as this report |
| TSM | foundry demand confirmation | Evidence moves in the same direction as this report |
...
| --- | --- | --- |
| AMAT | broad equipment dashboard | Confirms, contradicts, or bounds the same chain question |
| LRCX | etch/deposition dashboard | Confirms, contradicts, or bounds the same chain question |
