...
> **2026-07-31 stance re-adjudication at the 2026-07-30 close — supersedes the "not re-weighted / stance unchanged" language in the old note above.** Owner ruling on Q1 of the review-questions doc (2026-07-31): a published stance and its rationale must hold at the current price — the assessment is re-derived at the latest completed close rather than held open for future evidence. CRWV closed at **$73.90** on **2026-07-30**, +21.5% off the old 2026-07-29 low of $60.82 and **-14.5%** from the old $86.46 anchor. Recomputed on the report's own frames: market cap about **$33.1B**; on the unchanged ~$32.9B net debt, enterprise value about **$66.0B**, P/S (TTM) about **5.4x**, EV/Sales (TTM) about **10.7x**. The equity fell ~30% and rebounded ~22%, but the enterprise value — the number the bear case is actually about — moved a fraction of that (about -8% from the anchor at the trough, about -8% now: $71.6B -> $66.0B). The bearish-avoid case was never "the stock is expensive"; it is that a leveraged structure needs backlog conversion, GPU residual value and the refinancing window to hold together simultaneously. That case is EV-anchored and survives at the current price. **Stance stays bearish-avoid (medium conviction), re-derived at the current price.** Grid weights (20/30/50) retained; this discharges the scenario-grid-reweight-pending monitoring item ahead of the 2026-08-11 print.

> **2026-08-13 radar update: Q2 2026 results and the Q2 10-Q. Monitoring only — no valuation has been recomputed and neither stance nor conviction is re-adjudicated here.** CoreWeave reported Q2 2026 on **2026-08-11** and filed its Form 10-Q on **2026-08-12** for the period ended 2026-06-30. Revenue was **$2,575M** against $2,078M in Q1 2026 and $1,212M a year earlier (**+112%** year over year), with the 10-Q attributing about **93%** of the increase to expansion within the existing customer base. Operating loss was **-$49M** (a year earlier, +$19M), net loss **-$626M**, interest expense net **$640M**, and adjusted EBITDA **$1,510M** at a **59%** margin. Company-defined revenue backlog was approximately **$104B** at 2026-06-30, excluding more than **$25B** of net new customer commitments added in early Q3; unsatisfied **RPO was $103.7B**, of which **41%** is expected to be recognized over the initial 24 months to 2028-06-30, 39% in months 25-48 and the remainder in months 49-78. Total indebtedness was **$35.6B** with **$10.0B** undrawn, against operating lease liabilities of **$16.3B** and cash of $5,524M. Active power grew by nearly **500MW** to **1.5GW** and contracted power to about **3.7GW**.
>
> **The single most consequential change is customer concentration.** The 10-Q discloses top-three customers at **36%, 26% and 10%** of Q2 2026 revenue, against a single top customer at **71%** a year earlier. Readings, each graded strictly against that item's own published trigger: `revenue-quality-circularity` is **within** — the top two sum to 62%, below the trigger's roughly two-thirds threshold, and no NVIDIA contracted capacity backstop is restated in this filing; `real-demand-vs-financing` is **unclear** — the backlog-to-quarterly-revenue ratio narrowed from about 47x to about 40x, but recognized revenue still materially lags backlog; the NVIDIA backstop is not restated in this filing, so the current evidence cannot establish that the trigger is safely within; `solvency-gpu-life-stress` is **unclear**, because the filing discloses principal by calendar year rather than over a 24-month window and gives no GPU useful-life sensitivity or residual-value assumption, so that item's stress cannot be computed from the disclosed inputs; `self-build-pricing-crack` is **unclear**, because its first clause is decisively negative (commitments expanded) while GPU rental ASPs and utilization are undisclosed, leaving the disjunction undetermined.
>
> **What this does not do.** It does not re-derive the bearish-avoid stance, which remains anchored to the **2026-07-30 close of $73.90** with the historical price/date boundary set out above. It does record that the Q2 print supersedes the TTM denominators underneath the published **~5.4x P/S (TTM)** and **~10.7x EV/Sales (TTM)** figures, and that the **~$24.9B debt / ~$32.9B net obligation stack** frame is superseded by **$35.6B** of total indebtedness plus **$16.3B** of operating lease liabilities. Those figures are deliberately **not** recomputed here and are filed as a proposal in the run receipt for adjudication. One financing point avoids a double count: the release's **$3.1 billion term loan** highlight is the **DDTL 5.0** Facility entered in May 2026, not the $2.6B **DDTL 5.5** Facility dated 2026-08-07; the 10-Q adds that **$1.2B** has since been drawn under DDTL 5.5. Sources: [CoreWeave Q2 2026 results, 8-K Exhibit 99.1 (2026-08-11)](https://www.sec.gov/Archives/edgar/data/1769628/000176962826000362/coreweave2q26earningspress.htm); [CoreWeave Form 10-Q for the quarter ended 2026-06-30 (filed 2026-08-12)](https://www.sec.gov/Archives/edgar/data/1769628/000176962826000366/crwv-20260630.htm).

**Historical verdict context from the 2026-06-29 snapshot — retained for audit, with every price and balance-sheet figure in this paragraph superseded by the dated updates above:** **High-risk / bear-leaning (avoid-to-watch); the chain's risk anchor.** This is not a "high-quality, high-expectations" name like the rest of the book — it was framed as a high-operating-and-financial-leverage bet whose equity (~$52B market cap) sat above ~$22.9B of financial net debt before operating leases, or ~$32.9B including operating lease liabilities (obligation-adjusted EV ~**$85B**). At that snapshot the stock was ~**~~$96~~**, down ~**47%** from its 2025 highs and barely above the **$87** NVIDIA paid in January 2026. The bull case was real but narrow; the bear case was the base case. The current stance remains the 2026-07-31 bearish-avoid / medium-conviction adjudication, and the 2026-08-13 monitoring update does not recompute it.

**Old market read (2026-06-29 close snapshot, superseded by the 2026-07-31 re-adjudication):** CRWV ~**~~$96~~** (down ~47% from 2025 peaks near ~$180). On ~**540M** shares, market cap ~**$52B**. The Q1 2026 8-K shows **$24.9B debt**, **$0.24B finance lease liabilities**, **$10.05B operating lease liabilities**, and **$2.24B cash**: financial net debt is ~**$22.9B** before operating leases, while the net obligation stack is ~**$32.9B** including operating lease liabilities. That implies EV of ~**$74.9B** before operating leases, or ~**$85B** on an obligation-adjusted basis; gross debt+lease obligations are ~**41%** of that adjusted value. Financial source: [CoreWeave Q1 2026 8-K (SEC)](https://www.sec.gov/Archives/edgar/data/0001769628/000176962826000220/coreweave1q26earningspress.htm); quote references: [Yahoo Finance CRWV](https://finance.yahoo.com/quote/CRWV/), [StockAnalysis CRWV](https://stockanalysis.com/stocks/crwv/).
