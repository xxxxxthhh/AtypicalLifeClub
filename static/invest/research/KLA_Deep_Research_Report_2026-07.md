...
> **2026-07-31 stance re-adjudication at the 2026-07-30 close — supersedes the "not re-weighted / stance unchanged" language in the old note above.** Owner ruling on Q1 of the review-questions doc (2026-07-31): a published stance and its rationale must hold at the current price — the assessment is re-derived at the latest completed close rather than held open for future evidence. KLAC closed at **$180.33** on **2026-07-30**, +6.0% off the old 2026-07-29 low of $170.19 and **-23.4%** from the old $235.55 anchor. Recomputed on the report's own frames: market cap about **$235.5B**, enterprise value about **$236.5B**, EV/annualized revenue about **17.3x** on the July-2 base (old caliber 22.6x) and about **16.2x** on the Q4 FY2026 annualized base, LTM FCF yield about **1.7%** (old caliber ~1.3%). The cautious stance's stated premise — a grid-weighted view below what 22.6x embedded — does not survive a price 23% lower set against operating evidence that improved (Q4 revenue $3.658B, September-quarter guide $4.0B); no independent execution-risk leg was load-bearing. KLA still trades at a scarce-compounder premium, which is what keeps this from moving past neutral. **Stance moves cautious -> neutral-watch (medium conviction).** Grid weights (20/40/40) re-checked and retained as cycle-path probabilities; the grid's valuation verdicts should be read against this anchor. This discharges the scenario-grid-reweight-pending monitoring item ahead of the 2026-10-28 print.

**Current view:** ~~cautious / medium conviction~~ **neutral-watch / medium conviction (re-adjudicated 2026-07-31 at the $180.33 close — the separate current-price valuation review this paragraph called for is done; see the header note).** KLA has the strongest process-control quality signal in the batch, but the frozen July 2, 2026 price already embeds a large premium for AI yield demand, broad segment strength, and continued FCF support. Q4 fiscal 2026 evidence improved (revenue $3.658B, process control $3.257B, September-quarter guide $4.0B), but a separate current-price valuation review is required before changing the stance.
...
| Stance | neutral-watch / medium conviction (re-adjudicated 2026-07-31; old: cautious) |
...
| Financial anchor | ~~FY2026 Q3 revenue $3.416B, Semiconductor Process Control revenue $3.084B~~ **FY2026 Q4 revenue $3.658B, Semiconductor Process Control revenue $3.257B (reported 2026-07-28)** | Must be visible in revenue, margin, backlog, or cash flow |
| Valuation anchor | ~~Quarterly FCF $622.3M, LTM FCF $4.01B; new $7B buyback authorization~~ **Q4 FCF $817.1M, full-year FY2026 FCF $3.77B; Q4 dividends $305.3M and buybacks $571.0M**; frozen July 2, 2026 valuation frame (~22.6x EV/annualized revenue, ~1.3% LTM FCF yield) | Sets the tolerance for disappointment |
...
| --- | --- | --- |
| ASML | EUV/High-NA bottleneck | Evidence moves in the same direction as this report |
| AMAT | deposition/etch breadth | Evidence moves in the same direction as this report |
| LRCX | process-tool intensity | Evidence moves in the same direction as this report |
| TSM | advanced-node yield demand | Evidence moves in the same direction as this report |
...
| --- | --- | --- | --- |
| Revenue / demand | ~~FY2026 Q3 revenue $3.416B, Semiconductor Process Control revenue $3.084B~~ **FY2026 Q4 revenue $3.658B, Semiconductor Process Control revenue $3.257B** | Confirms whether the chain signal is visible in reported numbers | A-/B+ |
...
| Market-data values | Price snapshot kept at $235.55 and dated 2026-07-02 | Prevents stale valuation math |
...
| --- | --- | --- |
| Semiconductor Process Control revenue | process-control revenue keeps growing and validates advanced-manufacturing yield demand | next quarterly segment update |
| AI growth vectors | foundry/logic, memory, advanced packaging, and services all remain strong | CY2026 demand commentary |
| FCF and capital return | FCF supports dividends / buybacks without masking cycle weakness | cash flow and buyback update |
| Segment breadth | Specialty Semiconductor Process and PCB / Component Inspection do not drag core growth | segment mix update |
| CY2026 outlook and valuation tolerance | WFE or process-control demand cools, making high EV/sales and low FCF yield hard to sustain | guidance and valuation reset |
...
*Old frame, superseded by the 2026-07-31 re-anchor — the price, market cap, enterprise value and every multiple in this paragraph are old-caliber levels:* Valuation is used as risk context, not as a recommendation. The v5 question is whether the $235.55 dated price already assumes too much durable process-control scarcity and FCF resilience.

**Scenario grid:**

| Scenario | Driver assumptions (process-control demand, segment breadth, FCF, multiple regime) | Valuation implication (rich / fair / cheap vs today) | Subjective probability weight |
| --- | --- | --- | --- |
| Bull | Semiconductor Process Control revenue keeps compounding; AI demand stays broad across foundry/logic, memory, advanced packaging, and services; FCF grows faster than revenue; buybacks reduce share count without masking cycle risk; premium EV/sales is sustained | Current price would look fair only if process-control scarcity proves structurally tighter than the broader WFE cycle | 20% |
...
**What's priced in & the expectation gap:** *Old frame, superseded by the 2026-07-31 re-anchor — the price, market cap, enterprise value and every multiple in this paragraph are old-caliber levels:* In the frozen July 2, 2026 snapshot, at $235.55, about $308.9B EV, roughly 22.6x EV/annualized revenue, and about 1.3% LTM FCF yield, the market is pricing KLA as a scarce process-control compounder, not merely a cyclical equipment supplier. To justify that frame, the base case needs process-control growth, broad AI vectors, and FCF expansion to persist while the multiple compresses only slowly. Our 20% bull / 40% base / 40% bear grid puts the weighted view below that embedded expectation because a WFE cooling cycle would hit both revenue optics and the premium multiple. This is an expectations frame, not a target price. *(The Q4 FY2026 print and $4.0B September-quarter guide point to continued demand; the 2026-07-28 monitoring pass does not recompute this multiple on a current price, and any post-earnings share-price move alone is not a loggable signal.)*

## 9. Catalysts And Monitoring

| Monitor | Latest reading | Trigger | Next check |
| --- | --- | --- | --- |
| Semiconductor Process Control revenue | **Q4 FY2026 (2026-07-28): $3.257B, up from Q3's $3.084B (~+5.6% QoQ); trigger held** | process-control revenue keeps growing and validates advanced-manufacturing yield demand | next quarterly segment update (2026-10) |
| AI growth vectors | **Q4 FY2026 (2026-07-28): CEO framed demand as on the critical path of AI infrastructure, citing leading-edge foundry/logic, memory, and advanced packaging; Sept-quarter guide $4.0B extends it; no revenue split by end market** | foundry/logic, memory, advanced packaging, and services all remain strong | CY2026 demand commentary (2026-10) |
| FCF and capital return | **Q4 FY2026 (2026-07-28): operating cash flow $906.4M, FCF $817.1M (about -23% YoY from $1.065B); full-year FY2026 FCF $3.767B (about +0.5% from $3.747B); Q4 dividends $305.3M, buybacks $571.0M** | FCF supports dividends / buybacks without masking cycle weakness | cash flow and buyback update (2026-10) |
| Segment breadth | **Q4 FY2026 (2026-07-28): Specialty Semiconductor Process $160M (Q3 $164.0M, ~flat), PCB / Component Inspection $241M (Q3 $167.6M, up sharply); neither dragged core growth** | Specialty Semiconductor Process and PCB / Component Inspection do not drag core growth | segment mix update (2026-10) |
| CY2026 outlook and valuation tolerance | **Frozen July 2, 2026 snapshot: about 22.6x EV/annualized revenue, about 1.3% LTM FCF yield; not refreshed. Sept-quarter guide $4.0B +/- $200M points to continued demand; a separate current-price valuation review is required before re-rating** | WFE or process-control demand cools, making high EV/sales and low FCF yield hard to sustain | guidance and valuation reset (2026-10) |
...
| --- | --- | --- |
| ASML | EUV/High-NA bottleneck | Confirms, contradicts, or bounds the same chain question |
| AMAT | deposition/etch breadth | Confirms, contradicts, or bounds the same chain question |
| LRCX | process-tool intensity | Confirms, contradicts, or bounds the same chain question |
| TSM | advanced-node yield demand | Confirms, contradicts, or bounds the same chain question |

KLA's chain-validation job is unchanged: it checks whether AI capacity is becoming yieldable capacity through inspection, metrology, and process control rather than just installed tools.

The expectation gap is negative: in the frozen July 2, 2026 snapshot, at $235.55, roughly 22.6x EV/annualized revenue and about 1.3% LTM FCF yield, the market is already paying for scarce process-control compounding; our 20% bull / 40% base / 40% bear grid leaves the weighted view below that embedded expectation. The 2026-07-28 monitoring pass updates Q4 operating evidence (revenue $3.658B, process control $3.257B, September-quarter guide $4.0B) without re-valuing on a current price.

~~The current stance is **cautious, medium conviction**.~~ **2026-07-31 re-adjudication: the current stance is neutral-watch, medium conviction** — at the $180.33 close the negative valuation skew stated above no longer holds; see the header note. The old cautious reading reflected valuation skew, not weak quality: KLA is a premium asset, but the current frame needs process-control demand, broad AI vectors, and FCF support to stay strong while the multiple remains elevated. Medium conviction reflects high-quality reported revenue and cash-flow evidence, offset by mixed Q4-versus-full-year FCF evidence and WFE-cycle sensitivity.

Upgrade trigger: move to neutral-watch if process-control revenue keeps growing, AI growth vectors across foundry/logic, memory, advanced packaging, and services remain broad, LTM FCF yield improves without a weaker cycle signal, and the EV/sales frame contracts without price-driven downside. Downgrade trigger: move to bearish-avoid if WFE or process-control demand cools, Specialty Semiconductor Process or PCB / Component Inspection starts dragging core growth, FCF no longer supports buybacks/dividends, or valuation remains above 20x annualized revenue while guidance weakens.

## Appendix: Sources And Assumptions

- KLA fiscal Q3 2026 10-Q: [SEC filing](https://www.sec.gov/Archives/edgar/data/319201/000031920126000016/klac-20260331.htm).
- KLA fiscal Q3 2026 earnings release: [Exhibit 99.1](https://www.sec.gov/Archives/edgar/data/319201/000031920126000014/exhibit991earningsrelease3.htm).
- KLA fiscal Q4 2026 earnings release (2026-07-28): [KLA Investor Relations](https://ir.kla.com/news-events/press-releases/detail/518/kla-corporation-reports-fiscal-2026-fourth-quarter-and-full) — Q4 revenue $3.658B, Semiconductor Process Control $3.257B, quarterly and full-year FCF, retroactively split-adjusted per-share comparatives, and September-quarter guide.
- [KLA ten-for-one stock split announcement (2026-05-07)](https://ir.kla.com/news-events/press-releases/detail/515/kla-corporation-announces-ten-to-one-stock-split-and) — split effective June 11, 2026.
