...
> **Valuation boundary for the 2026-07-17 monitoring-only update:** The price, market-cap, enterprise-value, multiple, and scenario-grid figures below remain the explicitly dated Jul. 1 / Jul. 6, 2026 historical valuation snapshot. They are not a current Jul. 17 valuation and were not used to change the cautious / medium-conviction stance.
...
> **2026-07-31 stance re-adjudication at the 2026-07-30 close — supersedes the "not re-weighted / stance unchanged" language in the old note above.** Owner ruling on Q1 of the review-questions doc (2026-07-31): a published stance and its rationale must hold at the current price — the assessment is re-derived at the latest completed close rather than held open for future evidence. NBIS closed at **$188.43** on **2026-07-30**, +27.1% off the old 2026-07-29 low of $148.22 — the largest bounce in this coverage set — leaving it only **-11.5%** from the old $213.02 anchor. Recomputed on the report's own frames: market cap about **$41.6B**, enterprise value about **$41.8B**, P/S (TTM) about **47.3x**, EV/Sales (TTM) about **47.7x**. The bounce essentially restored the premise: at roughly 47x TTM sales the market is again paying for "the winning independent neocloud plus non-core optionality", which is exactly the claim the cautious stance rests on, so the stance is true at the current price, not merely held over. **Stance stays cautious (medium conviction)** — concentration, capex financing and the profit-ex-marks discount still apply. Grid weights (30/40/30) retained; this discharges the scenario-grid-reweight-pending monitoring item ahead of the 2026-08-12 print.

> **2026-08-13 radar update: Q2 2026 results. Monitoring only; no valuation has been recomputed and neither stance nor conviction is re-adjudicated here.** Nebius Group furnished two Forms 6-K on **2026-08-12** for the period ended 2026-06-30. Revenue from continuing operations was **$582.3M** against $399.0M in Q1 2026 (H1 $981.3M less Q2) and $105.1M a year earlier, **+454%** year over year. **Adjusted EBITDA turned positive at $236.2M** against -$21.0M, and total operating costs fell to **130%** of revenue from 206%. Net loss from continuing operations was **-$190.4M** in the quarter, while the first half still shows net income of **+$430.8M** on an operating loss of about **-$303.9M**. Second-quarter capital expenditure was **$5,657.4M** and first-half **$8,130.3M**; second-quarter operating cash inflow was **$2,246.1M**. Balance sheet at 2026-06-30: cash and equivalents **$8,042.1M**, **non-current debt $8,499.0M** (2025 year end $4,103.2M), non-current deferred revenue **$4,995.8M** ($1,302.0M), property and equipment net **$13,045.2M**, total assets **$27,961.5M**; Q2 interest expense **$119.1M**.
>
> Readings, each graded strictly against that item's own published trigger. `model-vs-balance-sheet` is **unclear**: both neoclouds grew recognized revenue, but Nebius did not restate ARR, CoreWeave backlog still stood at about 40x quarterly revenue, and **neither company discloses utilization**. Revenue growth is not a substitute for the trigger's required ARR/backlog conversion at high utilization. Nebius has also moved from "near net cash" to approximately net-debt-flat — $8,042.1M of cash against $8,499.0M of non-current debt. `earnings-quality-ex-marks` is **unclear**: the quarter answers its two halves in opposite directions, with no mark-driven profit in Q2 because there was no profit at all, while operations improved sharply at the EBITDA level without the GAAP operating line turning positive. `concentration-convergence` is **unclear** in the strict evidence sense — neither 6-K discloses any customer-level share of revenue. The trigger text is corrected to compare with CoreWeave's current high-concentration profile — its top two customers were **62%** of Q2 2026 revenue — rather than the obsolete >60% single-customer benchmark. This wording correction does not change the unclear reading.
>
> **One inference is explicitly refused.** Second-quarter operating cash inflow of $2,246.1M is roughly **3.9x the quarter's revenue** and can only be composed largely of customer prepayments and deferred revenue — non-current deferred revenue rose about $3,693.8M over the half, and the company lists advances received under strategic customer contracts among its principal liquidity sources. It must not be read as operations turning profitable. The price, market-cap, enterprise-value, multiple and scenario-grid figures below remain the dated Jul. 1 / Jul. 6, 2026 snapshot with the **2026-07-30** re-adjudication above; the Q2 print supersedes their TTM denominators, which are deliberately **not** recomputed here and are filed as a proposal in the run receipt. Sources: [Nebius Q2 2026 results, Form 6-K Exhibit 99.1 (2026-08-12)](https://www.sec.gov/Archives/edgar/data/1513845/000110465926094568/tm2622968d1_ex99-1.htm); [Nebius operating and financial review and unaudited condensed consolidated financial statements, Form 6-K (2026-08-12)](https://www.sec.gov/Archives/edgar/data/1513845/000110465926094844/nbis-20260812xex99d1.htm).
...
**Historical market read (2026-07-01 snapshot; superseded by the 2026-07-31 valuation adjudication and the Q2 balance sheet above):** NBIS ~**~~$240~~** (a volatile, high-beta name; it printed ~**$256** and ~**$66B** market cap around its June-22 Nasdaq-100 inclusion, and was up roughly **+165-185% YTD**). On ~**253.9M shares outstanding** (issued and outstanding, excluding treasury, at Mar. 31, 2026), market cap was ~**$61B** at ~ ~~$240~~ (~$60-66B across late-June/early-July). The Q1 2026 balance sheet showed ~**$9.3B cash** against ~**$8.4B** of non-current debt and ~**$1.0B** of operating lease liabilities; within non-current debt, ~$4.34B was convertible notes and ~$2.0B was a prefunded-warrant instrument (quasi-equity, associated with NVIDIA's $2B strategic investment). On that historical financial-debt basis, Nebius was roughly **net-cash-neutral to ~$5B net cash** depending on prefunded-warrant treatment; after operating leases, it was roughly **lease-adjusted neutral to ~$4B net cash**. Historical EV was therefore roughly **$57-61B**. These are audit-only figures, not the current display state. Sources: [Nebius Q1 2026 press release (SEC 6-K)](https://www.sec.gov/Archives/edgar/data/0001513845/000110465926064092/nbis-20260331xex99d2.htm); quote references: [Yahoo Finance NBIS](https://finance.yahoo.com/quote/NBIS/), [StockAnalysis NBIS](https://stockanalysis.com/stocks/nbis/), [Macrotrends NBIS market cap](https://www.macrotrends.net/stocks/charts/NBIS/nebius-group/market-cap).
...
**2026-07-17 monitoring update (no stance change):** According to [Nebius's Jul. 17 company release](https://nebius.com/newsroom/nebius-raises-775-million-in-first-secured-debt-financing-to-accelerate-global-buildout), the company **entered into** its first senior secured debt facility for approximately **$775M**. The facility is backed by deployed GPU infrastructure and contracted cash flows from an agreement with an unnamed investment-grade customer, matures **Oct. 31, 2030**, and is priced at **SOFR + 2.50%**. Nebius says the transaction was significantly oversubscribed and that, together with cash flows under the customer agreement, it covers **more than 100% of the capex** required for the underlying GPU deployment. This is evidence that one asset-level financing has been arranged, but not that the present facility is tied to Microsoft or Meta: the release leaves the customer unnamed and separately says the structure could be repeated against more than $40B of additional contracted revenue from investment-grade customers such as Microsoft and Meta. That repeatability and any similarly attractive future terms remain company expectations. The release does not disclose drawdown status, fees, covenants, amortization, or the customer. The facility is also small beside the $20-25B 2026 capex range, so it does not by itself fund the ramp. This update does not refresh the Jul. 6, 2026 valuation snapshot; the cautious / medium-conviction stance is unchanged.
...
- **2026-08-21 incremental update — that offering has priced and was upsized to US$5.0B.** Per the Form 6-K furnished 2026-08-20 and its Exhibit 99.1 press release (the release is dated 2026-08-19): the proposed offering described above has priced, **upsized from US$4.50B to US$5.00B** aggregate original principal amount, in two series — **US$3.00B of 0.50% notes due 2030-02-15** and **US$2.00B of 4.50% notes due 2034-02-15** — with settlement **expected 2026-08-24**, subject to customary closing conditions. The initial-purchaser option was correspondingly adjusted to up to **US$450M** (2030 Notes; previously US$375M) and **US$300M** (2034 Notes, unchanged from the original announcement). The company estimates net proceeds of approximately **US$4.94B** (about US$5.68B if the option is fully exercised). Initial conversion prices are about **US$313.46** for the 2030 Notes (a premium of approximately **40.0%** over the US$223.90 Nasdaq close on 2026-08-19) and about **US$324.65** for the 2034 Notes (approximately **45.0%**). Accretion lifts the amount payable at maturity to **110%** of original principal (2030 Notes) and **125%** (2034 Notes); after that accretion the issuer discloses **effective** conversion prices of about **US$344.81** (an effective premium of about 54.0%) and about **US$405.82** (about 81.3%). The exchange size is now fixed: agreements with a limited number of holders of the 2.00% 2029 and 3.00% 2031 convertibles will exchange **US$400M** of original principal of each for an aggregate of approximately **15.8 million** Class A ordinary shares, also expected to settle on or about 2026-08-24; the issuer states the notes offering is not contingent on completion of the exchanges.
  - **Current-cycle correction to the entry above.** The "US$4.50B, US$2.75B 2030 / US$1.75B 2034, options of US$375M / US$300M" figures in the preceding entry were the caliber announced while the offering was **proposed**; the current post-pricing caliber is the US$5.00B total with US$3.00B / US$2.00B tranches recorded here. The preceding entry stands as correct on the evidence then available; this entry supersedes its size and terms figures on post-pricing evidence.
  - **Limits that must be read alongside this.** **Settlement has not yet occurred** and remains subject to customary closing conditions; the US$450M and US$300M are initial-purchaser **options**, not issued amounts. Beyond naming data-center construction and procurement of key components including GPUs, the use-of-proceeds language **still lists "general corporate purposes"** alongside them, so proceeds are not fully earmarked, and US$5.0B is a portion of, not the whole of, the US$20-25B 2026 capex program. The issuer **does not restate** the ">90% secured" 2026 capex percentage in this release. No **yield to maturity is disclosed**, so this entry does not derive an all-in cost of capital from the coupons and accretion percentages — coupons, accretion percentages and effective conversion prices are recorded as the issuer states them. This update **recomputes nothing** — no valuation, enterprise value, dilution, or net-cash position; §8's valuation caliber at the 2026-07-30 close of $188.43 is retained unchanged. Source: [Nebius Form 6-K Exhibit 99.1 (pricing, furnished 2026-08-20)](https://www.sec.gov/Archives/edgar/data/1513845/000110465926098924/tm2623617d1_ex99-1.htm).
  - **What to watch next:** **actual settlement** on 2026-08-24 and the final issued size (including whether the option is exercised), and whether the company restates its 2026 capex secured percentage in a subsequent disclosure.
- **2026-08-25 incremental update — that offering has closed, the options were exercised in full, and the total rose to US$5.75B.** Per the Form 6-K furnished 2026-08-24 and its Exhibit 99.1 press release (accession `0001104659-26-100347`; release dated Amsterdam, August 24, 2026): the priced two-series private offering of convertible senior notes described above has **closed**. The initial purchasers exercised their options **in full**, purchasing an additional **US$450M** (2030 Notes) and **US$300M** (2034 Notes), so the aggregate original principal amount is **US$3.45B for the 0.50% notes due 2030** and **US$2.3B for the 4.50% notes due 2034**, **US$5.75B in total**. The release headlines that figure as aggregate gross proceeds of approximately US$5.75B and states it in the body as total aggregate original principal amount; this report preserves both of the source's calibers rather than collapsing them. Two indentures, each dated August 24, 2026, were entered into with **U.S. Bank Trust Company, National Association** as trustee, one per series. Use-of-proceeds language is unchanged from pricing and still lists **general corporate purposes** alongside data-center construction and build-out, full-stack AI cloud investment, footprint expansion, and procurement of key components including GPUs.
  - **Current-cycle correction to the entry above.** The "US$5.00B, US$3.00B 2030 / US$2.00B 2034" figures in the preceding entry were the caliber **at pricing**, when the options had not been exercised; the current post-closing caliber is the **US$5.75B** total with the **US$3.45B / US$2.3B** split recorded here. The preceding entry held on the evidence available then; this one supersedes its size figures on post-closing evidence. The coupons, maturities, initial conversion prices (about $313.46 / $324.65), premia (about 40.0% / 45.0%) and post-accretion effective conversion prices all come from the 2026-08-19 pricing release and are **not restated** in this closing release, so they remain attributed to the preceding entry's date and source.
  - **Limits that must be read alongside this.** This release **discloses no net-proceeds figure**. The "about US$5.68B if the option is fully exercised" recorded in the preceding entry was the **pricing release's estimate at the time**, not a figure disclosed at closing, and must not be cited as a realized net amount. The exchange of approximately **15.8 million** Class A ordinary shares for US$400M of original principal of each of the 2029 and 2031 series is described by the release as having been entered into **concurrently with the pricing**; it matches the preceding entry and is **not newly disclosed here**. The issuer **still does not restate** the ">90% secured" coverage of its 2026 capex in this disclosure. US$5.75B is roughly **23%-29%** of that US$20-25B capex range, and the proceeds are not fully earmarked. This update **recomputes nothing** — no valuation, enterprise value, dilution, or net-cash position; §8's valuation caliber at the 2026-07-30 close of $188.43 is retained unchanged.
  - **What to watch next:** whether the company restates its 2026 capex secured percentage in a subsequent disclosure (the only caliber that speaks directly to this report's funding-durability trigger); post-closing drawdown, covenant and fee disclosures; and the subsequent cadence of ABS issuance, ATM use and customer prepayments.
...
**Metrics to monitor continuously:** ARR and utilization, operating income ex-marks, customer concentration, capex vs operating cash flow, cash and net-cash position, convertible/ATM dilution (including the two-series convertible offering announced and priced 2026-08-19, which closed 2026-08-24 at US$5.75B of aggregate original principal after the initial purchasers exercised their options in full), prepayment cadence, and — as the cross-check — the same metrics at CoreWeave.
...
- [Nebius Jul. 17, 2026 secured-financing release](https://nebius.com/newsroom/nebius-raises-775-million-in-first-secured-debt-financing-to-accelerate-global-buildout) — first approximately $775M senior secured facility, collateral/cash-flow support, maturity, pricing, issuer-described demand, and evidence limits.
