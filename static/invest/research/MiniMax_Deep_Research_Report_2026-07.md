...
> **2026-08-26 Alibaba connected-transaction update; company fact, not a chain signal.** MiniMax raised the 2026/2027/2028 annual caps for cloud purchases from Alibaba from **US$115M / US$125M / US$135M** to **US$300M / US$400M / US$500M**; H1 2026 purchases were **US$75.6M** and the old 2026 cap was 65.7% utilized. It raised the caps for API services sold to Alibaba from **US$0.65M / US$1.0M / US$1.5M** to **US$7.5M / US$22.0M / US$33.0M**, with 77.2% utilization of the old 2026 cap. The issuer says the caps are estimates and must not be read as actual or future financial performance; they are contractual ceilings, not orders, backlog, or delivered compute. ~~The separately proposed 20% general-mandate refresh remains subject to independent-shareholder approval and is not executed dilution.~~ **2026-09-15 approval-status correction:** the extraordinary general meeting approved the refreshed 20% general issuance mandate (169,765,833 votes for, 94.86%; 9,200,858 against, 5.14%) and both supplemental Alibaba agreements with revised annual caps. Resolution 4 adds shares repurchased under the 2025 AGM repurchase mandate to the general issuance mandate, with the added number capped at 10% of shares issued at that AGM; **it does not add a further 10% repurchase mandate**. Issued shares at the EGM were 349,235,308 (268,132,774 Class A and 81,102,534 Class B), with no treasury shares. Votes differ from voting shares because each Class B share carries ten votes. Approval alone does not establish executed issuance, conversion or procurement; nor does this poll announcement prove that none occurred subsequently. This paragraph corrects the company approval fact only: it does not advance the `funding-dilution` reading or evidence date, or revalidate the historical valuation, stance or conviction. No existing cross-check predicate covers this capital-markets-funded procurement structure, so no signal is attached to the cap revision.
...
12. [MiniMax EGM poll results, 2026-09-15](https://www1.hkexnews.hk/listedco/listconews/sehk/2026/0915/2026091501293.pdf)
