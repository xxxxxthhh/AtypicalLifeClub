...
**One-line thesis:** SanDisk is the world's largest pure-play NAND flash company — when AI data centers generate and store petabytes of training data, inference outputs, and model checkpoints, the storage layer beneath the compute is dominated by NAND SSDs. Freshly spun off from Western Digital, SanDisk has delivered a quarter for the record books: Q3 FY2026 revenue of **$5.95B** (+97% Q/Q, +251% Y/Y), GAAP gross margin of **78.4%**, operating margin of **69.1%**, and FCF of **$3.0B** — numbers that look more like a software platform than a memory manufacturer. The market has noticed: market cap surged to ~**$310B** (old caliber) and, after the July drawdown and the 07-30 rebound, stands at about **$189.4B** at the 2026-07-30 close. But NAND is one of the most cyclical sub-sectors in semiconductors, and the question is not whether these margins are real (they are), but how long they last.

**Verdict:** ~~Cautious / medium conviction.~~ **Neutral-watch / medium conviction (re-adjudicated 2026-07-31 at the $1,279.96 close — the expectation-gap inversion held even after the bounce; see the header note).** SanDisk's execution in the NAND up-cycle is extraordinary, and the AI-driven storage demand story has clear, quantifiable tailwinds (Datacenter revenue +233% Q/Q). ~~But the v5 scenario grid puts more weight on cycle math than on linear growth: a **$310B market cap on ~$19B FY2026E revenue (~16x P/S) already prices in sustained peak margins**, while NAND pricing is historically boom-bust.~~ **2026-07-31 update: the cycle-math premise has inverted.** At the adopted **2026-07-30 close of $1,279.96** the market cap is about **$189.4B** on the same ~$19B FY2026E revenue, i.e. about **9.8x P/S** (the 07-29 trough was ~$150B / ~7.8x, a superseded intermediate) — the market is no longer paying for sustained peak margins, it is pricing a substantial cycle roll-over. NAND pricing is still historically boom-bust; what changed is which side of that the price now assumes.

> **2026-07-31 valuation re-anchor (old note — its 07-29 figures are a superseded intermediate; the current anchor is the 07-30 close in the block below).** No new quarter was reported (SanDisk's next release is scheduled for 2026-08-05), so the operating fact base below is unchanged. SNDK fell from the old $2,090.71 anchor (2026-06-26) to **$1,015.89** at the **2026-07-29 close**, **−51.4%**, as part of a broad July 2026 AI-infrastructure and memory drawdown that was verified as a real price move, not a stock split or other corporate action. This pass re-anchors price, market cap and the P/S and P/E frames, and — importantly — records that **the report's central expectation-gap argument has reversed sign**, which is set out in §8. It does **not** re-weight the scenario grid or change the stance, which stay **cautious / medium conviction** pending the 2026-08-05 print and an owner decision.

> **2026-07-31 stance re-adjudication at the 2026-07-30 close — supersedes the "pending an owner decision" language in the old note above.** Owner ruling on Q1 of the review-questions doc (2026-07-31): a published stance and its rationale must hold at the current price — the assessment is re-derived at the latest completed close rather than held open for future evidence. SNDK closed at **$1,279.96** on **2026-07-30**, +26.0% off the old 2026-07-29 low of $1,015.89 and still **-38.8%** from the old $2,090.71 anchor. On the same ~148M shares outstanding: market cap about **$189.4B**, enterprise value about **$185.7B** (zero debt); FY2026E P/S about **9.8x**, trailing GAAP P/E about **40x**, forward P/E on the $120-132 annualized-Q4 guide about **9.7-10.7x**. On the report's own 12-15x through-cycle frame the price implies sustainable EPS of about **$85-107** — still **below** the $120-132 peak annualized guide even after the bounce. The cautious stance was built on the opposite claim (a price implying above-peak sustainable EPS); that premise has not merely weakened, it points the other way, and no independent leg of this report supports "cautious" at a price already discounting a meaningful trough. Whether the $42B NBM backlog actually lifts the trough is unproven — which is what keeps this from being constructive. **Stance moves cautious -> neutral-watch (medium conviction)** ahead of the 2026-08-05 print. Grid weights (20/40/40) re-checked and retained; at this price the market sits between the base and bear rows rather than above the bull row. This discharges the scenario-grid-reweight-pending monitoring item.

> **2026-08-06 radar update: the Q4 FY2026 print has landed, superseding the “next test is the 2026-08-05 print” / “pending the 2026-08-05 print” language above.** Sandisk reported Q4 FY2026 (quarter ended 2026-07-03) on **2026-08-05**: revenue **$8,965M** (up 51% Q/Q, up 372% Y/Y), with GAAP and non-GAAP gross margin both **84.6%**, above the 79-81% guide; GAAP diluted EPS was $43.97 (including an $804M non-operating gain on equity securities, reconciled out of non-GAAP) and non-GAAP diluted EPS $39.25. Datacenter revenue was $2,977M (up 103% Q/Q), and FY2026 revenue was $20,248M (up 175%). The company disclosed five additional NBM agreements this quarter - three with new customers and two expansions - bringing the announced total to ten. The release does not disclose minimum contracted revenue, RPO, guarantees, or committed-bit coverage, so this update does not confirm the old report's roughly $42B management framing. Q1 FY2027 guidance is revenue of $10,300-10,800M and non-GAAP diluted EPS of $44.00-46.00.
>
> **This is a monitoring-only update; no valuation has been recomputed.** The **$120-132 peak annualized EPS frame**, **FY2026E P/S of about 9.8x**, and the old “pending Q4” language are superseded by the new print; they remain only as an explicitly dated 2026-07-30 historical snapshot, not as current values. The revenue / gross-margin leg of the upgrade trigger is satisfied. The NBM contract leg remains unclear because the release does not disclose amounts, RPO, guarantees, or bit coverage. Price, market cap, multiples, scenario grid, stance (**neutral-watch / medium conviction**), and conviction are not recomputed in this monitoring update; they require the Form 10-K and a separate full research update. Source: [Sandisk Q4 FY2026 earnings release (2026-08-05)](https://investor.sandisk.com/news-releases/news-release-details/sandisk-reports-fiscal-fourth-quarter-2026-financial-results). The company states these are preliminary results that may differ when the Form 10-K is filed.

**Current market read (2026-07-31 re-adjudication, at the 2026-07-30 close):** SNDK closed at **$1,279.96** on **2026-07-30**, the last completed U.S. session. On the same ~**148M shares outstanding** that is a market cap of about **$189.4B**, and about **$185.7B** enterprise value against $3.74B cash and zero debt. (The diluted share count is ~**157M**, the basis for per-share earnings.) *Superseded intermediate (old caliber): the 2026-07-29 trough close of $1,015.89 and ~$150B market cap used earlier in this pass.* ~~SNDK was last quoted around ~**$2,091**, market cap ~**$309.6B** (CompaniesMarketCap); it had set an all-time-high close of ~$2,335 (~$346B) on June 25... this ranks SanDisk among the ~50 largest companies globally.~~ The 52-week range is ~**$40.10 - $2,354.39** — an extreme range reflecting the post-spin re-rating from a single-digit reference price, and now a roughly halving from the June peak. Financial source: [SanDisk Q3 FY2026 8-K](https://www.sec.gov/Archives/edgar/data/2023554/000162828026028879/sndkq3-26ex991xpressrelease.htm); quote references: [CompaniesMarketCap SNDK](https://companiesmarketcap.com/sandisk/marketcap/), [Yahoo Finance SNDK](https://finance.yahoo.com/quote/SNDK/).

**Key data:**

| Metric | Value |
|--------|-------|
| Price (2026-07-30 close, re-adjudicated) | **~$1,279.96** (superseded intermediate: ~$1,015.89 at the 2026-07-29 trough; old anchor ~$2,091 at 2026-06-26) |
| Market cap | **~$189.4B** (superseded intermediate ~$150B; old anchor ~$309.6B) |
| Diluted shares | ~157M (EPS basis, Q3 FY2026); ~148M shares outstanding (market-cap basis); ~158M guided for Q4 |
| EV/Sales (FY2026E) | **~9.6x** (EV ~$185.7B on FY2026E revenue ~$19.0-19.5B; zero debt); old caliber ~16x |
| FY2026E P/S | **~9.8x** (superseded intermediate ~7.8x; old anchor ~16x) |
| TTM P/E (GAAP) | **~39-42x** (9-mo FY2026 net income $4.53B: Q1 $112M + Q2 $803M + Q3 $3,615M); superseded intermediate ~31-33x; old caliber ~65-70x |
...
Q4 guidance at $7.75-8.25B implies another ~30-39% sequential revenue growth and gross margins still expanding to ~80%. This would bring FY2026 full-year revenue to approximately **$19.0-19.5B** — placing SanDisk's forward P/S at ~~~16x~~ **~9.8x at the 2026-07-30 close adopted by the 2026-07-31 re-adjudication**, materially lower than the ~24x TTM multiple initially screened. However, 80% gross margins are peak-of-cycle, not mid-cycle; normalized margins over a full NAND cycle are substantially lower.
...
5. **Forward valuation is more reasonable than it first appears.** FY2026E P/S ~~~16x~~ **~9.8x (2026-07-31 re-adjudication, 07-30 close)** on ~$19B revenue; if FY2027 sustains or grows from here, the stock screens cheaper than AI chip peers — and after the July drawdown this point is considerably stronger than when written.
...
- **FY2026E P/S ~~~16x~~ ~9.8x (2026-07-31 re-adjudication, 07-30 close):** market cap ~**$189.4B** (~~~$309.6B~~) / FY2026E revenue ~$19.0-19.5B (YTD $11.28B + Q4 guidance $7.75-8.25B). For context: NVIDIA ~19x on ~$253B TTM revenue, Broadcom ~24x on ~$75B TTM revenue (both as screened in June and not re-verified in this pass). SanDisk at ~9.8x P/S on $19B revenue is now priced **well below** those AI chip leaders rather than between them — a change of kind, not degree. The caveat still stands and still matters: this is P/S on **peak-cycle** revenue, and in a NAND down-cycle revenue can contract 20-40%, so P/S on normalized revenue would be materially higher than 9.8x.
- **TTM P/E ~~~65-70x~~ ~39-42x (GAAP, 2026-07-31 re-adjudication, 07-30 close):** 9-month FY2026 GAAP net income was **$4.53B** (Q1 $112M + Q2 $803M + Q3 $3,615M), so TTM net income is ~$4.5-4.8B and the trailing P/E on the ~**$189.4B** market cap is **~39-42x** (superseded intermediate: ~31-33x on the ~$150B 07-29 trough cap; old caliber: ~65-70x on ~$310B, and ~73x against the late-June high). By comparison, NVIDIA trades at ~25x forward and Broadcom at ~33x (June screen, not re-verified here) — so SanDisk's *trailing* multiple is now **moderately above** Broadcom's rather than ~2x higher. On a **forward** basis (Q4 annualized: $30-33 EPS × 4 ≈ $120-132), the forward P/E drops to ~~~15-16x~~ **~9.7-10.7x**. The bull case is correspondingly stronger; **the bear rebuttal is unchanged and is the whole question — the forward estimate still rests on peak-cycle EPS that may not annualize.**
- **EV/Sales ~~~16x~~ ~9.6x (2026-07-31 re-adjudication, 07-30 close):** with zero debt and $3.74B cash, EV is ~**$185.7B** (~~~$306B~~) — essentially market cap less net cash. EV-based multiples mirror equity-based ones.
- **Reading the multiple (re-anchored 2026-07-31):** SanDisk's valuation is largely a bet on **NAND cycle duration.** ~~At 16x peak-cycle P/S and ~15-16x annualized forward P/E, the stock looks reasonable — but only if current earnings are sustainable.~~ At **~9.8x peak-cycle P/S** and **~9.7-10.7x** annualized forward P/E, the stock looks inexpensive on peak earnings — but the conditional is unchanged and is doing all the work: that only holds if current earnings are sustainable. If margins normalize to mid-cycle levels, both the multiple and earnings contract — the classic commodity-cycle double compression. The new variable is the **$42B NBM backlog**: if contracted, guarantee-backed revenue genuinely raises the cycle trough, the double compression is partially capped; if it merely re-times the same cyclical revenue, the bear math holds. The bull case is that AI plus contracts structurally extend the cycle; the bear case is that history repeats.

**Scenario grid:**

| Scenario | Driver assumptions (NAND pricing / NBM coverage / margin / multiple regime) | Valuation implication *(stale — written against the ~16x / $2,090.71 frame)* | Probability weight *(stale as written — re-adjudicated 2026-07-31: weights retained)* |
|----------|----------------------------------------------------------------------------|------------------------------------------------------|--------------------|
| Bull | AI storage demand accelerates; NAND supply stays disciplined; NBM filings confirm roughly $42B minimum revenue and coverage moves toward more than half of FY2027 bits; 75%+ gross margin persists; the market treats SanDisk as a structural AI storage asset rather than a commodity-cycle name | (old frame, stale) The $2,090.71 price looks fair only if the NBM structure lifts the trough and extends peak-like margins through FY2027 | 20% |
...
⚠️ **Scenario grid not re-weighted in the 2026-07-31 pass.** Every "vs today" verdict above was written against the **$2,090.71 / ~$310B / ~16x** frame and does not follow from the same driver assumptions at **$1,279.96 / ~$189.4B / ~9.8x**. The driver assumptions themselves remain valid; the valuation verdicts are stale as written. **Re-adjudicated 2026-07-31:** the owner ruling has been applied — the 20/40/40 weights were re-checked and retained as cycle-path probabilities, the stance moved to neutral-watch, and the verdict column should be read against the $1,279.96 / ~$189.4B / ~9.8x frame (see the header note).

**What's priced in & the expectation gap — this argument has inverted (rewritten 2026-07-31).** The original reasoning ran: ~~at the $2,090.71 price anchor and Q4 annualized EPS of about $120-132, the stock looks like only about 16x peak run-rate earnings; at 12-15x through-cycle sustainable EPS, today's price implies roughly `$2,090.71 / 15 ≈ $139` to `$2,090.71 / 12 ≈ $174` of sustainable EPS, above even the Q4 annualized guide — so the market is underwriting a structurally higher trough before the NBM evidence has proved it, and the expectation gap is negative.~~

Run the identical arithmetic at the adopted **2026-07-30 close of $1,279.96** and it points the other way. Against the same Q4 annualized EPS of about $120-132, the stock is at roughly **10x peak run-rate earnings**. On the same 12-15x through-cycle frame, the price implies sustainable EPS of about `$1,279.96 / 15 ≈ $85` to `$1,279.96 / 12 ≈ $107` — **below**, not above, the $120-132 peak annualized guide. In other words the market has moved from underwriting a *structurally higher* trough to pricing a trough roughly **19-29% below** peak run-rate earnings, which is the direction the bear row of the grid describes. (At the old 2026-07-29 trough of $1,015.89 the same frame gave ~8x and $68-85, i.e. a 35-45% discount — a superseded intermediate reading; the 07-30 rebound narrowed the implied discount without closing it.)

**The honest conclusion is that the negative expectation gap this report asserted no longer follows from its own arithmetic — it has reversed sign.** What has *not* changed is the underlying uncertainty: NBM coverage is still unproven, gross margin is still at a cyclical 78-80%, and NAND remains boom-bust. Whether an ~10x peak-earnings multiple is now too cheap depends entirely on where the true trough sits, which is exactly the question the NBM evidence has not yet answered. This pass therefore re-states the arithmetic and flags the inversion rather than flipping the stance on it.
...
**2026-07-31 monitoring update (no stance change):** The "hyperscaler capex guidance (MSFT, GOOG, META, AMZN) — storage is derivative of total infrastructure spend" line above now needs a price-versus-volume split before it can be read as storage volume. On its Q2 2026 earnings call Amazon raised the 2026 cash-capex guide to about $220B from about $200B and attributed the roughly $20B raise to higher memory prices rather than added capacity — **earnings-call coverage, not the official release**; CNBC, Seeking Alpha and Fortune agree on the figure and the attribution, while the release publishes neither. The release's forward-looking-statement language does name "resource and supply volatility, including for memory chips" (verified in the Q2 2026 Exhibit 99.1 on EDGAR), but that is standing wording carried over from the FY2025 10-K rather than a new Q2 disclosure. Two consequences for this report. **On pricing, it is direct buyer-side corroboration:** memory prices are high enough to move the largest cloud buyer's annual capital plan by $20B, which is independent evidence for the cycle strength sitting behind the 78-81% gross margins and for why hyperscale customers were willing to sign contracted, guarantee-backed NBM supply in the first place. **On monitoring, it degrades the derivative-of-capex heuristic:** a rising hyperscaler capex dollar figure is no longer a clean proxy for rising bit demand, because part of the increase buys the same units at a higher price. Bit shipments, contracted volumes and Datacenter revenue — not the capex headline — are the volume readings to track from here. The bear case is served as well: the buyer that has now itemized memory inflation at $20B is the same buyer whose next contract round decides whether backlog of the NBM type gets extended at these prices. Stance and conviction unchanged — **neutral-watch / medium conviction**, as re-adjudicated on 2026-07-31.
...
**2026-07-31 update — this conclusion has inverted.** The prior text read: "The expectation gap is negative: at $2,090.71, the market is underwriting roughly $139-174 of through-cycle sustainable EPS on a 12-15x memory-cycle frame, which is above even the Q4 annualized EPS guide of about $120-132." At the adopted **2026-07-30 close of $1,279.96**, the same 12-15x frame implies roughly **$85-107** of sustainable EPS — **below** the $120-132 peak annualized guide rather than above it (the 07-29 trough gave $68-85, a superseded intermediate). The market has swung from pricing a structurally higher trough to pricing one meaningfully below peak. The NBM structure still has not proved that peak NAND earnings are sustainable, so the *uncertainty* is unchanged; but the *direction* of the expectation gap no longer follows from the report's own math, and the 20/40/40 grid needs re-judging (see the review questions doc).

~~The current stance is **cautious, medium conviction**.~~ **2026-07-31 re-adjudication: the current stance is neutral-watch, medium conviction** — the price now implies sustainable EPS below the peak guide, so the old negative gap no longer exists; see the header note. The bull case is powerful because NBM contracts and AI storage demand may raise the next trough. But the base and bear cases carry 80% combined weight and both include gross-margin normalization from the 78-80% zone. Medium conviction reflects strong current evidence in Q3 results, FCF, zero debt, and NBM commitments, offset by the still-unproven durability of NAND pricing and contract protection.

Upgrade trigger: move to constructive if FY2026 Q4 delivers the $7.75-8.25B revenue and 79-81% gross-margin guide, NBM filings confirm roughly $42B of minimum revenue with coverage moving toward more than half of FY2027 bits, and NAND contract prices plus industry capex still show supply discipline. Downgrade trigger: move to cautious if NAND contract prices weaken for consecutive periods, gross margin falls materially from the 78-80% peak, NBM coverage or guarantees fall short of management's framing, or SanDisk/Kioxia capacity additions point to 2027 oversupply.
...
- **Re-adjudicated 2026-07-31 at the 07-30 close:** market cap ~**$189.4B** ≈ ~148M shares outstanding × the **2026-07-30 close of $1,279.96** (repo price ledger `static/invest/research/data/prices.json`). *Superseded intermediate (old caliber): ~$150B on the 2026-07-29 trough close of $1,015.89.* ~~Market cap ~$309.6B per CompaniesMarketCap (late June 2026) ≈ ~148M shares outstanding × ~$2,091; it reached ~$346B at the June 25 all-time-high close (~$2,335).~~ Diluted share count ~157M is the per-share-earnings basis ($3,615M ÷ $23.03); ~158M guided for Q4.
- FY2026E revenue ~$19.0-19.5B = YTD 9-month $11,283M + Q4 guidance midpoint ~$8,000M. FY2026E P/S **~9.8x** (~~~16x~~; superseded intermediate ~7.8x).
- 9-month FY2026 GAAP net income $4.53B (Q1 $112M + Q2 $803M + Q3 $3,615M); TTM net income ~$4.5-4.8B including Q4 FY2025. Trailing GAAP P/E **~39-42x** (~~~65-70x~~; superseded intermediate ~31-33x) after the 2026-07-31 re-adjudication; the back quarters were trough earnings, so the trailing multiple still overstates run-rate profitability.
- Forward P/E (annualized Q4) = $30-33 EPS × 4 ≈ $120-132; at the adopted **2026-07-30 close of $1,279.96** the forward P/E is **≈ 9.7-10.7x** (~~at $309.6B / 157M shares = ~$1,972 price, forward P/E ≈ 15-16x~~; superseded intermediate ≈ 7.7-8.5x at the 07-29 trough). This is an illustrative annualization, not a forecast.
