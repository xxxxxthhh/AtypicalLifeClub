...
>
> 按报告自身的收入情景重算：EV/Sales 现约 **12.6x**（按 FY2027 $11.5B）、约 **8.8x**（按 FY2028 $16.5B），而下文旧口径为约 **19x** 与约 **13x**。报告“这不是便宜的半导体股”的判断是按约 19x 校准的；在约 12.6x 下，这已是一个实质不同的主张。
>
...
| 指标 | 数值 |
|------|------|
| 股价 | **$163.40**（2026-07-29 收盘）；旧锚点 $245.29（2026-07-02） |
| 市值 / 股本 | **约 $143.1B**（2026-07-29）；约 8.758 亿股。旧口径约 $214.6B |
...
| 估值 | **市值约 $143.1B，EV/FY2027E Sales 约 12.6x**（旧口径：$214.6B、约 19x） | 对执行失误的容错空间较此前更宽，但失误风险本身未变 | Caution |

*旧表述，已于 2026-07-31 失效：“这不是便宜的半导体股。若 FY2028 收入真的到 $16.5B，当前 EV/Sales 约 13x，仍然高；如果 FY2027 只接近 $11.5B，则约 19x。”* **重新锚定：按 $163.40、EV 约 $144.5B，EV/Sales 约 8.8x（FY2028 $16.5B）、约 12.6x（FY2027 $11.5B）。** 论证结构未变——倍数完全取决于收入走哪条路径——但水平已不再支撑原表述。
...
3. **估值过高——2026-07-31 已削弱。** ~~约 19x FY2027E EV/Sales 对任何收入延迟都很敏感。~~ **按重新锚定的旧 07-29 价 $163.40，EV/Sales 约 12.6x FY2027E；按 07-30 重新裁定收盘约 14.1x（见页首）。** 对收入延迟的敏感性性质未变，但程度已下降。
...
以下是估值上下文，不是建议。**2026-07-31 重新锚定：价格锚点为 2026-07-29 收盘 $163.40**（旧锚点为 2026-07-02 的 $245.29）。

| 方法 | 当前读数 | 解读 |
|------|----------|------|
| 市值 | **约 $143.1B**（旧口径约 $214.6B） | 仍按 AI custom silicon 平台定价，但倍数已明显下降 |
| EV | 约 （旧口径）$215.7B | 净债务不高，估值主要来自股权溢价 |
| EV/TTM Sales | 约 25x | 当前收入基数无法支撑估值，必须看 forward |
| EV/FY2027E Sales | **约 12.6x**（用 $11.5B）；旧口径约 19x | 容错空间较此前更宽 |
| EV/FY2028E Sales | **约 8.8x**（用 $16.5B）；旧口径约 13x | 仍需兑现才能解释 |
...
**已经定价的预期与差距（2026-07-31 重写）：** *旧表述已失效（$245.29、EV 约 $215.7B、约 19x FY2027E sales）。* 以 **$163.40**、EV 约 **$144.5B**、约 **12.6x FY2027E sales**（按 $11.5B 框架）计，市场对 FY2027/FY2028 收入 ramp 的要求已明显降低。支撑原负预期差的隐含年增长门槛因倍数下降而放松；但 custom ASIC 订单转化、光互连 attach 与利润率等执行项完全未被回撤解决。因此本次记录预期差依据已变，网格与立场待所有者裁定。
...
**2026-07-31 更新——本结论依据已变。** *旧文：预期差距为负：在 $245.29、约 19x FY2027E sales 上，市场已经要求 FY2027/FY2028 收入 ramp 顺利兑现并继续复合。* 按 **$163.40**、约 **12.6x** FY2027E sales，该隐含增长门槛已明显下移，负预期差的算术依据减弱；执行不确定性未变。网格与立场未变动，等待 2026-08-27 业绩。
