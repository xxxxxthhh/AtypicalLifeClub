...
> **2026-07-31 价格复核。** ANET 于 **2026-07-29**（最后一个已完成交易日）收于 **$157.97**，对照下文标注日期的 **$164.10** 锚点为 **-3.7%**。因此下文标注日期的锚点在该误差范围内依然准确，估值框架、情景网格、立场与确信度均不变。已在 2026-07-31 全覆盖复核中核对确认，无需修改。
...
按 2026 年 6 月 29 日收盘市值 **$206.62B** 和 Q1 2026 现金/可交易证券约 **$12.35B** 计算，企业价值约 **$194B**。按 2026 年 4 月 30 日 **12.59 亿股**流通股，对应股价约 **$164/股**；`prices.json` 记录的价格锚点为 **2026-06-29 的 $164.10**。
...
| 情景 | 驱动假设（增长 / 利润率 / 倍数区间） | 相对 $164.10 日期价格的估值含义 | 概率权重 |
|------|--------------------------------------|----------------------------------|----------|
...
**已经定价的预期与差距：** 在 **$164.10**、约 **20x EV/TTM 收入** 上，市场并不是把 ANET 当普通交换机周期股定价。若成熟高质量网络/软件倍数更接近 **10-12x 收入**，且投资者要求约 **8%** 年回报，三年反推倍数框架意味着收入需要约 `((20 / 12)^(1/3) x 1.08 - 1) ≈ 28%` 到 `((20 / 10)^(1/3) x 1.08 - 1) ≈ 36%` 的复合增长，同时利润率保持优秀。我们的基准情景接近这个隐含区间低端，而不是明显高于它：增长仍强、利润率仍好，但客户集中和架构路线风险仍在。因此预期差距是平衡的，不是正偏。
...
预期差距是平衡的：在 $164.10、约 20x EV/TTM 收入上，市场大致要求未来数年收入维持高 20% 至 30% 中段复合增长并保持优秀利润率；我们的基准情景接近这个区间低端，而不是明显高于它。
