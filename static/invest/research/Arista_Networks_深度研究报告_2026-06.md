...
**当前判断：** **中性观察 / 中等确信：高质量，基本定价。** 我更愿意在估值回落，或者开放以太网在 AI 后端网络中拿到更明确、可持续份额证据时，才把 ANET 从“必须跟踪”提升为“积极买入”。公司本身具备本中心喜欢的质量：高增长、高利润率、大额净现金、深度 hyperscaler 暴露，而且直接回答 AI 集群架构问题。但 2026-06-29 的价格已经预支了多年 AI 网络扩张和非常高的执行质量。
...
**当前市场口径：** 以 2026-07-30 收盘 **$171.02** 与 Arista 2026 年 4 月 30 日 **12.59 亿股**流通股计算，市值约 **$215.3B**（旧锚点为 CompaniesMarketCap/Nasdaq 的 2026 年 6 月 29 日收盘市值 $206.62B）。以 Q1 2026 现金及可交易证券约 **$12.35B**、基本无有息债务计算，企业价值约 **$203B**。

> **2026-08-05 监测更新（雷达）：** [Arista 向 SEC 提交的 Q2 公告](https://www.sec.gov/Archives/edgar/data/1596532/000159653226000174/ex991q226-earningsrelease.htm)于 2026-08-04 披露收入 $3.036B（+37.7%，公司首个单季破 $30 亿）、非 GAAP 营业利润率 49.9%、非 GAAP 每股收益 $1.02、Q3 收入指引约 $3.3B。已将 open-ethernet-vs-integrated 读数更新为 within（readingAsOf 2026-08-04）。它确认开放以太网收入与利润率一腿，不确认相对 NVIDIA 的 AI 后端份额。本次为仅监测更新：估值、立场、确信度与价格锚点（2026-07-30 收盘 / 2026-07-31 裁定）不变。

> **2026-09-01 客户集中度复核：** [Arista 的 Q2 2026 Form 10-Q](https://www.sec.gov/Archives/edgar/data/1596532/000159653226000175/anet-20260630.htm)没有披露季度客户集中度，只重述 FY2025 两家匿名终端客户分别占收入 26% 与 16%。因此“占比进一步上升”本季不可观测；收入同比 +37.7%、环比 +12.1% 且 Q3 指引约 $3.3B，则不支持“订单节奏骤变”。customer-concentration 读数据此为 unclear（readingAsOf 2026-08-05）；估值、立场、确信度与价格锚点均不变。

> **旧价格复核批注 —— 按其写法已失效，被下方的重新裁定取代。** ~~2026-07-31 价格复核：ANET 于 2026-07-29 收于 $157.97，对照 $164.10 锚点为 -3.7%，因此下文锚点在该误差范围内依然准确，估值框架、情景网格、立场与确信度均不变，无需修改。~~

> **2026-07-31 立场重新裁定（锚定 2026-07-30 收盘）。** 业主裁决（2026-07-31）：已发布的立场及其理由必须在**当前价格**上成立。ANET 于 **2026-07-30** 收于 **$171.02**，较 2026-06-29 的旧锚点 $164.10 为 **+4.2%**。按 12.59 亿股与约 $12.35B 现金及可交易证券（基本无有息债务）计，市值约 **$215.3B**（旧 $206.62B）、企业价值约 **$203B**（旧约 $194B）；对应约 **21x EV/TTM 收入**（旧约 20x）、约 **49x** 当前非 GAAP EPS 运行率（旧约 47x）、约 **58x** TTM GAAP 净利润（旧约 56x）。本次没有改动任何预估或实际值，只改了价格输入。按本报告自身的三年反推倍数框架（向 10-12x 收入正常化、要求回报约 8%）重算，隐含要求升至约 **30% 至 38% 收入复合增长**（旧约 28% 至 36%）。此前判定为中性观察，正是因为基准情景落在该区间低端附近而非高于它；4.2% 的变动没有在性质上改变这一关系：基准情景现在离低端更远了一点，这使中性观察更明确成立，而不是更不成立。**立场维持中性观察（中确信），并按更高倍数重新表述。**
...
| 市值 | 约 $215.3B（2026-07-30 收盘） |
| 隐含股价 | 按 12.59 亿股流通股约 $164/股 |
| 企业价值 | 扣除现金及可交易证券后约 $203B |
...
4. **估值容错率低。** 约 **21x EV/TTM 收入**、约 **49x 当前非 GAAP EPS 运行率**下，即使公司仍然优秀，普通减速也可能让股价承压。
...
按 2026-07-30 收盘市值约 **$215.3B** 和 Q1 2026 现金/可交易证券约 **$12.35B** 计算，企业价值约 **$203B**。`prices.json` 记录的价格锚点现为 **2026-07-30 的 $171.02**。

| 指标 | 粗略数值 | 解读 |
|----|----|----|
| 市值 | 约 $215.3B | 2026-07-30 收盘 × 12.59 亿股 |
...
| 市值 / TTM GAAP 净利润 | ~58x | 高预期 |
| 当前非 GAAP EPS 运行率 | ~$3.5 | Q1/Q2 约 $0.87-0.88/季度 |
| 股价 / 当前非 GAAP EPS 运行率 | ~49x | 质量已被定价 |

**情景表：**

| 情景 | 驱动假设（增长 / 利润率 / 倍数区间） | 相对 $171.02 当前价格的估值含义 | 概率权重 |
|------|--------------------------------------|----------------------------------|----------|
| 牛市 | 开放以太网持续拿到 AI 后端网络份额；Cloud and AI Titans / AI Specialty 需求让产品收入维持高 20% 至低 30% 复合增长；非 GAAP 营业利润率维持 40% 后半段；递延收入/RPO 继续转化且客户集中度不恶化；市场继续给系统软件型网络公司高倍数 | 只有当 ANET 证明自己是多年 AI fabric 复合增长标的，而不是普通网络周期股时，当前价格才偏合理甚至略便宜 | 30% |
| 基准 | AI 网络需求仍强，但 Q2 式增长从 Q1 降档；开放以太网与 NVIDIA 一体化网络都增长；头部客户集中度仍高；非 GAAP 营业利润率维持 40% 中段；EV/TTM 收入从约 20x 向十几倍的高质量溢价回落 | 当前价格大致合理：质量真实，但大部分基准情景已被资本化 | 50% |
| 熊市 | NVIDIA 一体化栈拿走更多价值，某个头部客户放缓或转向，Broadcom silicon 节奏/价格影响路线图，AI 大客户折扣把非 GAAP 营业利润率压到 40% 以下；倍数回到普通高质量网络公司框架 | 当前价格会显得偏贵，因为收入增长和溢价倍数会同时压缩 | 20% |

**已经定价的预期与差距（2026-07-31 按 2026-07-30 收盘重新推导）：** 在 **$171.02**、约 **21x EV/TTM 收入** 上，市场并不是把 ANET 当普通交换机周期股定价。若成熟高质量网络/软件倍数更接近 **10-12x 收入**，且投资者要求约 **8%** 年回报，三年反推倍数框架意味着收入需要约 `((20 / 12)^(1/3) x 1.08 - 1) ≈ 28%` 到 `((20 / 10)^(1/3) x 1.08 - 1) ≈ 36%` 的复合增长，同时利润率保持优秀。我们的基准情景接近这个隐含区间低端，而不是明显高于它：增长仍强、利润率仍好，但客户集中和架构路线风险仍在。因此预期差距是平衡的，不是正偏。
...
ANET 的链条验证任务是判断网络层最终变成开放 Ethernet 系统/软件机会，还是变成加速器厂商垂直一体化堆栈机会。若 Arista 继续扩大递延收入/RPO、维持 40%+ 营业利润率，并显示大型 AI 客户选择 Ethernet fabric，开放以太网和 Broadcom merchant silicon 一侧的链条证据会增强；若这些指标变弱，AI 网络利润池可能正在迁移到 NVIDIA 一体化栈。

预期差距是平衡的、门槛略有抬高：在 2026-07-30 收盘 $171.02、约 21x EV/TTM 收入上，市场大致要求未来数年收入维持约 30% 至 38% 复合增长并保持优秀利润率；我们的基准情景现在略低于这个区间低端，而不只是接近它。

当前 stance 是 **neutral-watch，中等确信**。30% 牛市 / 50% 基准 / 20% 熊市情景表说明 ANET 是优秀公司，但基准情景在当前日期价格上已经大多被资本化。中等确信来自清晰的利润率、现金和客户相关性，同时被开放以太网 vs 一体化栈的架构不确定性抵消。

上调触发器：若 Q2/Q3 财报使收入增速保持在高 20% 以上、非 GAAP 营业利润率维持 45% 以上、递延收入/RPO 扩张，并且客户证据显示开放以太网在 AI 后端网络份额提升且集中度未进一步上升，则上调至 constructive。下调触发器：若收入增速跌破隐含的高 20% 路径、非 GAAP 营业利润率在缺少明确投资解释的情况下低于 40%、头部客户集中度恶化，或 NVIDIA 一体化网络在 AI 后端拿到更清楚份额，则下调至 cautious。
