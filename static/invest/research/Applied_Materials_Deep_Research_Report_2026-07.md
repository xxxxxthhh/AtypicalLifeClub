...
**One-line thesis:** Broad equipment dashboard for the AI-infrastructure semicap-equipment layer. AMAT tests whether AI demand is spreading beyond EUV into deposition, etch, advanced packaging, DRAM, and services. Q2 FY2026 revenue was $7.91B, GAAP gross margin was 49.9%, and non-GAAP EPS was $2.86; Semiconductor Systems revenue was $5.965B, with foundry/logic/other at 67% and DRAM at 29%. Q3 guidance is $8.950B revenue +/- $500M and non-GAAP EPS of $3.36 +/- $0.20. At (old caliber) $603.04, about $478.8B market cap and $477.8B EV, AMAT traded around 13.3x EV/Q3 annualized sales and 36.8x forward EPS. ~~Cautious~~ **Neutral-watch (re-adjudicated 2026-07-31 at $501.77)** / medium conviction: the upcycle is strong; the old mildly negative skew claim no longer holds at the current price, while China/Taiwan exposure keeps this a watch.

> **2026-07-31 valuation re-anchor.** AMAT closed at **$436.45** on **2026-07-29** (the then-last completed session; old low, superseded by the re-adjudication below), **-27.6%** from the old $603.04 anchor dated 2026-07-02. This is part of the verified July 2026 chain-wide AI-infrastructure repricing — checked for corporate actions and confirmed a real price move. Recomputed at the new price: market cap about **$346.5B**, enterprise value about **$345.6B**, P/S (TTM) about **11.9x**, EV/Sales (TTM) about **11.9x**. The dated price, market-cap and multiple figures below are **superseded as levels**; read them as of their labels.
>
...
> **2026-07-31 stance re-adjudication at the 2026-07-30 close — supersedes the "not re-weighted / stance unchanged" language in the old note above.** Owner ruling on Q1 of the review-questions doc (2026-07-31): a published stance and its rationale must hold at the current price — the assessment is re-derived at the latest completed close rather than held open for future evidence. AMAT closed at **$501.77** on **2026-07-30**, +15.0% off the old 2026-07-29 low of $436.45 and **-16.8%** from the old $603.04 anchor. Recomputed on the report's own frames: market cap about **$398.4B**, enterprise value about **$397.5B**, P/S (TTM) about **13.7x**, EV/Q3-annualized sales about **11.1x** (old caliber 13.3x), forward EPS multiple about **30.6x** (old caliber 36.8x). The cautious stance was an arithmetic claim — that the price already embedded a broad WFE upcycle which the 20/50/30 grid could not quite underwrite. At about 11.1x EV/annualized sales, just above the report's own 8-10x through-cycle band, that mildly negative gap no longer holds at the current price, and no independent execution-risk leg was load-bearing. **Stance moves cautious -> neutral-watch (medium conviction).** The grid's probability weights are re-checked and retained — they encode fundamental cycle paths, not the old multiple — and the grid's valuation-implication column should now be read against this anchor. China/Taiwan exposure and the 2026-08-13 print keep this a watch, not a constructive call. This discharges the scenario-grid-reweight-pending monitoring item.

**Current view:** ~~cautious / medium conviction~~ **neutral-watch / medium conviction (re-adjudicated 2026-07-31 at the $501.77 close — see the header note).** AMAT is the broadest WFE dashboard in this batch, but at the July 2 price the market is already paying for AI demand to spread through deposition, etch, advanced packaging, DRAM, and services while China/Taiwan exposure stays manageable.
...
| --- | --- | --- |
| ASML | lithography constraint | Evidence moves in the same direction as this report |
| LRCX | etch/deposition intensity | Evidence moves in the same direction as this report |
| KLAC | yield/process control | Evidence moves in the same direction as this report |
| TSM | capex customer signal | Evidence moves in the same direction as this report |
...
| Market-data values | Price snapshot kept at $603.04 and dated 2026-07-02 | Prevents stale valuation math |
...
| --- | --- | --- |
| Semiconductor Systems growth | systems revenue and operating margin continue confirming a broad WFE upcycle | FY2026 Q3 earnings |
| Foundry/logic and DRAM mix | foundry/logic and DRAM both stay strong, validating advanced logic and HBM demand | segment and end-market mix |
| China/Taiwan revenue exposure | export controls or customer timing affect China/Taiwan revenue | geographic revenue and restrictions |
| Q3 guidance conversion | revenue approaches or exceeds the $8.95B midpoint without EPS / margin slippage | FY2026 Q3 results |
| Supply-chain and inventory readiness | higher build plan, inventory, and logistics capacity convert to orders rather than inventory risk | inventory and supply-chain update |
...
| --- | --- | --- | --- |
| Semiconductor Systems growth | Q2 Semiconductor Systems revenue was $5.965B with 35.1% operating margin | systems revenue and operating margin continue confirming a broad WFE upcycle | FY2026 Q3 earnings |
| Foundry/logic and DRAM mix | Q2 mix: foundry/logic/other 67%, DRAM 29%, Flash 4% | foundry/logic and DRAM both stay strong, validating advanced logic and HBM demand | segment and end-market mix |
| China/Taiwan revenue exposure | Q2 geography: Taiwan 27%, China 27%, Korea 20% | export controls or customer timing affect China/Taiwan revenue | geographic revenue and restrictions |
| Q3 guidance conversion | Q3 guidance is $8.950B revenue +/- $500M and non-GAAP EPS $3.36 +/- $0.20 | revenue approaches or exceeds the $8.95B midpoint without EPS / margin slippage | FY2026 Q3 results |
| Supply-chain and inventory readiness | management said it increased build plan, inventory, and logistics capacity | higher build plan, inventory, and logistics capacity convert to orders rather than inventory risk | inventory and supply-chain update |
...
| --- | --- | --- |
| ASML | lithography constraint | Confirms, contradicts, or bounds the same chain question |
| LRCX | etch/deposition intensity | Confirms, contradicts, or bounds the same chain question |
