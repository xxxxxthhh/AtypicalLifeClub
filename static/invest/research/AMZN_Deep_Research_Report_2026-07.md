...
| Memory / HBM | About $20B of the $20B capex raise attributed to higher memory prices (call coverage); the release's own guidance risk factors now name "resource and supply volatility, including for memory chips" | Confirms memory tightness for Micron/SK hynix/SanDisk — **and simultaneously shows that hyperscaler capex dollars can rise on price rather than volume** |
