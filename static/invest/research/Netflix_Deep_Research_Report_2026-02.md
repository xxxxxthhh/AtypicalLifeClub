...
> **2026-07-31 price check (anchor corrected 2026-08-09).** NFLX closed at **$73.63** on **2026-07-29**, the last completed US session, versus the current **$68.95** anchor dated **2026-07-17** — a **+6.8%** move. The dated figures below therefore remain accurate to within that margin and the valuation frame and stance are unchanged. Prices in this report are post-split: Netflix executed a 10-for-1 split on 2025-11-17, before this report's February coverage date, so no split adjustment is required. The prior note incorrectly compared against the superseded $71.82 / 2026-06-25 anchor. `priceSymbol: NFLX` and this completed-session anchor now wire the report into the automatic price ledger.
...
| Metric | Value (2026-02) | Value (2026-07-17 Update, incl. Q2 2026) |
|--------|----------------|---------------------------|
| Price | ~~~$81~~ | ~~$71.82~~ **$68.95** (-7.3% single session post-Q2) |
| Market Cap | ~~~$350B~~ | ~~$302.5B~~ **~$290.3B** |
| P/E (TTM) | ~~~32x~~ | ~~23.17x~~ **≈23.4x** (self-calc: $68.95 / $2.95 TTM EPS) |
| Forward P/E | ~~~26-29x~~ | ~~22.37x~~ **≈18.1x** |
| P/S (TTM) | — | ~~6.45x~~ **≈6.0x** ($290.3B / $48.37B TTM revenue) |
| P/B | — | ~~9.72x~~ **≈9.33x** ($68.95 / $7.39 BVPS) |
| EV/EBITDA | — | 21.32x (2026-06-25 baseline frame, not rebuilt for Q2) |
| TTM Revenue | ~~$45.2B~~ | ~~$46.89B~~ **$48.37B** (incl. Q2 2026) |
| Q2 2026 Quarterly Revenue | — | **$12.56B (+13.4% YoY)** |
| FY2025 Revenue | $45.2B (+16% YoY) | Unchanged |
| FY2026 Revenue Guidance | — | **$51.0–51.4B** (narrowed), operating margin **31.5%** |
| Q3 2026 Revenue Guidance | — | **$12.86B (+11.7% YoY)**, below ~$13B consensus |
| Q2 Operating Margin | — | **33.4%** (34.1% in Q2'25) |
| TTM Operating Margin | ~~29.5%~~ | 32.30% (2026-06-25 basis) |
| TTM Net Income | — | ~~$13.37B~~ Q2 quarterly net income **$3.4B** (EPS $0.80) |
| TTM OCF | — | $12.65B (2026-06-25 basis); FCF ≤ OCF |
| Cash / Debt | — | ~~Cash $12.29B / Total Debt $16.74B~~ **Cash $9.13B / Total Debt $14.31B (net debt ~$5.18B)** |
| TTM Diluted EPS | — | ~~$3.10~~ **$2.95** (incl. Q2; Q2 quarterly $0.80, all post 10:1 split) |
| Paid Subscribers | 325M (Q4 2025) | Subscriber count no longer reported; H1 2026 member view time **97B+ hours (+2% YoY)**, viewership disclosure further reduced |
| Ad Revenue | >$1.5B (2025) | 2026 target to double to ~$3B (full-year TBD) |
| 52-Week Range | ~~$79 - $135+~~ | ~$68.95, down ~49% from 52-week high $134.12 |
...
Founded in 1997 and headquartered in Los Gatos, California, Netflix is the world's largest streaming video platform. The company went public on NASDAQ in 2002 and is currently led by co-CEOs Ted Sarandos (content) and Greg Peters (product & operations), with founder Reed Hastings serving as Executive Chairman.

### Business Model

Netflix's revenue comes from three segments:

**1. Subscription Revenue (~97% of 2025 revenue)**
- Standard with Ads: $7.99/month (US)
- Standard: $17.99/month
- Premium: $24.99/month
- 325 million paid subscribers across 190+ countries

**2. Advertising Revenue (rapidly growing)**
- 2025 ad revenue exceeded $1.5B, up 150% YoY
- 190 million monthly active ad-tier viewers
- 2026 target: double to ~$3B
- Expected to reach ~15% of total revenue by 2026

**3. Other Revenue**
- Gaming (mobile, currently small scale)
- Merchandise and experiences
- Content licensing (beginning to license select content to third parties)

### Content Ecosystem

- **Original Content:** World's largest original content investor, ~$18B content spend in 2025
...
The global video streaming market was valued at approximately $811B in 2025, projected to reach $3.4 trillion by 2034. Netflix leads the US market with 20-22% share.

### Competitive Landscape

| Platform | US Market Share | Global Paid Subs | Core Advantage |
|----------|----------------|-----------------|----------------|
...
- **Global Network:** 190+ country coverage with local content production capabilities
...
>
> **[2026-07-17 Update | Q2 2026 earnings]** Q2 2026 revenue **$12.56B (+13.4% YoY)**, operating income **$4.2B (+11% YoY)**, operating margin **33.4%** (34.1% in Q2'25, a slight YoY step-down), net income **$3.4B**, diluted EPS **$0.80**. TTM revenue rose to ~**$48.37B**. Market data as of 2026-07-17: cash ~**$9.13B** / total debt ~**$14.31B** (net debt ~$5.18B, up modestly vs Q1). FY2026 revenue guidance narrowed to **$51.0–51.4B**, operating margin **31.5%**; Q3 2026 revenue guided to **$12.86B (+11.7%)**, below the ~$13B consensus. Source: Netflix Q2 2026 shareholder letter / 8-K (2026-07-16).

### Key Financial Trends

**Revenue ($B):**
- 2022: $31.6B → 2023: $33.7B → 2024: $39.0B → 2025: $45.2B
- 3-Year CAGR: ~13%, accelerating to 16% in 2025
...
- From $1.6B to $9.5B in three years
...
- **Ted Sarandos** (co-CEO): Content strategy, 20+ years at Netflix, led DVD-to-streaming transition
- **Greg Peters** (co-CEO): Product, technology, and operations; drove ad tier and password sharing crackdown
- **Reed Hastings** (Executive Chairman): Founder, strategic advisor role
- **Spencer Neumann** (CFO): Former Activision Blizzard CFO, strong financial discipline

### Evaluation

**Execution: A**
- Password sharing crackdown added tens of millions of new subscribers with surgical precision
- Ad tier from zero to $1.5B revenue in just two years
- Operating margin expanded from 17.8% to 29.5%
...
- 190M monthly active ad-tier viewers with very low monetization rate
- Benchmarked against YouTube ($36B ad revenue), Netflix's ad ceiling is enormous
...
- Q1 2026 guidance missed analyst expectations
- Password sharing crackdown one-time boost largely digested
- Developed market subscriber growth approaching ceiling
- EPS growth expected to slow from 28% (2025) to 22% (2026)

**3. Heavy Insider Selling**
- Ted Sarandos sold ~$200M in stock over 6 months
- Greg Peters sold ~$8.7M recently
- Insiders collectively sold nearly 1 million shares recently
- Zero insider purchases on record
- Signals management's lack of confidence in near-term outlook

**4. Content Cost Arms Race**
- 2026 content spend expected to reach $20B
- Competitors (Disney, Amazon, Apple) continue increasing investment
- Talent and IP cost inflation
...
- When we'll know: Full-year 2026 advertising revenue data

**3. Optimal Scale of Content Spending**
- Why it matters: Is $20B/year too much? Can ROI be maintained?
...
### Current Valuation Snapshot (2026-07-17)

| Metric | Value | Notes |
|--------|-------|-------|
| Price | $68.95 | -7.3% single session after 2026-07-16 Q2 print (prior close $74.35) |
| Market Cap | ~$290.3B | ~4.21B shares (post 10:1 split basis) |
| TTM P/E | ≈23.4x | Self-calc: $68.95 / $2.95 TTM EPS |
| Forward P/E | ≈18.1x | Market data (Forward EPS ≈$3.82) |
| P/S (TTM) | ≈6.0x | Self-calc: $290.3B / $48.37B TTM revenue |
| P/B | ≈9.33x | $68.95 / $7.39 BVPS |
| Cash / Debt | $9.13B / $14.31B | Net debt ~$5.18B |
| EV/EBITDA | 21.32x (baseline frame) | 2026-06-25 basis, not rebuilt for Q2, treat as stale reference |
| FCF Yield (est.) | ~3.7% | FCF ~$10.7B (2026-06-25 basis) / MC $290.3B |
...
- ✅ ~~Q2 2026 earnings (expected July)~~ — **[2026-07-16 reported]** Revenue $12.56B (+13.4%), operating margin 33.4%, EPS $0.80; FY2026 revenue guidance narrowed to $51.0–51.4B.
- ⚠️ **[2026-07-16]** Q3 2026 revenue guidance $12.86B (+11.7%) below the ~$13B consensus; stock -7.3% on the print — decelerating growth is the new near-term pressure point
- 📅 Ad-tier monetization and live/sports slate progress (viewership disclosure being cut back — falling transparency to monitor)
...
- Sports/live content long-term strategy

---

## 10. Conclusion

Netflix delivered an outstanding 2025: $45.2B revenue (+16%), 29.5% operating margin, $9.5B free cash flow, and 325M paid subscribers. Q1 2026 continued the momentum: TTM revenue $46.89B (+16.2%), operating margin further expanded to 32.30%, net income $13.37B. **[2026-07-17 update]** Q2 2026 revenue $12.56B (+13.4%), operating margin 33.4%, EPS $0.80, TTM revenue up to ~$48.37B; but Q3 revenue guidance of $12.86B (+11.7%) came in below consensus, making the quarter-by-quarter deceleration the new focal debate.
...
**Our View (Updated 2026-07-17):**
- At **$68.95** (TTM P/E ≈23.4x, Forward P/E ≈18.1x), the priced-in pessimism has deepened further since June, down ~49% from the 52-week high $134.12; Q2 growth held up but the soft Q3 guide means a re-rating needs stronger evidence from ads and content ROI
- ~~At $71.82 (TTM P/E 23.17x, Forward P/E 22.37x), the stock already reflects considerable pessimism, down 45% from 52-week high $134.12~~ (2026-06-25 basis, superseded by the line above)
...
- JustWatch market share data

### Peer Comparison

| Metric | Netflix | Disney (DTC) | Amazon Prime Video | Spotify |
|--------|---------|-------------|-------------------|---------|
| Paid Subscribers | 325M | ~126M | ~200M+ | 290M |
